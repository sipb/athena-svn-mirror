...
#	  $Source: /afs/dev.mit.edu/source/repository/third/ssh/make-ssh-known-hosts.pl,v $
#	  Author : $Author: danw $
#
...
#	  Last check in     : $Date: 1999-03-08 17:42:54 $
...
$version = ' $Id: make-ssh-known-hosts.pl,v 1.1.1.3 1999-03-08 17:42:54 danw Exp $ ';
