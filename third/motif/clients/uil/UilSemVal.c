...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: UilSemVal.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:39 $"
#endif
#endif
 ...
 */
                if (cTable->obj_header.az_name == NULL)
                {
                  diag_issue_diagnostic
                    ( d_wrong_type,
	...
	case cstr_arg_type:	/*  comp_str */;
		   ...
		   & sym_m_separate) != 0 )
		{
		  ...
		  value_entry->value.l_integer = 
		    (long)XmStringConcat((XmString)value_entry->az_exp_op1->
