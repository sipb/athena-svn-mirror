...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: UilSrcSrc.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:39 $"
#endif
#endif
...
src_open_file (XmConst char *c_file_name,
               char         *full_file_name)
#else
src_open_file (c_file_name,full_file_name)
...
#else
open_source_file( c_file_name, az_fcb, az_source_buffer )
  XmConst char           *c_file_name;
  uil_fcb_type           *az_fcb;
  src_source_buffer_type *az_source_buffer;
#endif
...
#else
reget_line( az_fcb, c_buffer, z_access_key )
  uil_fcb_type  *az_fcb;
  char          *c_buffer;
  XmConst z_key *z_access_key;
#endif
...
#else
src_append_diag_info( az_src_rec, l_src_pos, c_msg_text, l_msg_number )
  XmConst src_source_record_type *az_src_rec;
  XmConst int                     l_src_pos;
  XmConst char                   *c_msg_text;
  XmConst int                     l_msg_number;
...
#else
src_append_machine_code ( az_src_rec, l_offset, l_code_len, c_code, c_text_arg )
