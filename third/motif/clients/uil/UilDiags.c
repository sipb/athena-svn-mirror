...
char
#ifndef _NO_PROTO
*diag_tag_text( int XmConst b_tag )
#else
*diag_tag_text( b_tag )
  int XmConst  b_tag;
#endif
...
char
#ifndef _NO_PROTO
*diag_object_text( int XmConst b_type )
#else
*diag_object_text( b_type )
  int XmConst b_type;
#endif
{
...
char
#ifndef _NO_PROTO
*diag_value_text( int XmConst b_type )
#else
*diag_value_text( b_type )
  int XmConst b_type;
#endif
{
...
char
#ifndef _NO_PROTO
*diag_charset_text( int XmConst b_type )
#else
*diag_charset_text( b_type )
  int XmConst b_type;
#endif
{
...
void
#ifndef _NO_PROTO
diag_initialize_diagnostics(void)
#else
...
void
#ifndef _NO_PROTO
diag_reset_overflow_handler(void)
#else
...
void
#ifndef _NO_PROTO
diag_handler( int l_error )
#else
diag_handler( l_error )
  int l_error;
#endif
{
    /* 
...
void
#ifndef _NO_PROTO
diag_issue_internal_error( char *error_text )
#else
diag_issue_internal_error( error_text )
  char *error_text;
#endif
...
void
#ifndef _NO_PROTO
write_msg_to_standard_error (XmConst int  message_number, 
                             XmConst char *src_buffer, 
                             XmConst char *ptr_buffer, 
                             XmConst char *msg_buffer, 
                             XmConst char *loc_buffer)
#else
write_msg_to_standard_error (message_number, src_buffer, ptr_buffer, 
                             msg_buffer, loc_buffer)
...
char XmConst 
#ifndef _NO_PROTO
*diag_get_message_abbrev( int d_message_number )
#else
*diag_get_message_abbrev( d_message_number )
  int d_message_number;
#endif
{
    return
