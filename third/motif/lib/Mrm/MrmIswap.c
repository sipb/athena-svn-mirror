     ...
     
{
	...
	{
	    swap4bytes(header_rec->RID_pointers[ndx].internal_id.rec_no);
	    swap4bytes(header_rec->RID_pointers[ndx].internal_id.item_offs);
	}
	...
	for( ndx=0 ; ndx < leaf_rec->leaf_header.index_count ; ndx++ ) 
	{
	    ...
	    swap4bytes( leaf_rec->index[ndx].data.internal_id.rec_no );	
	    swap4bytes( leaf_rec->index[ndx].data.internal_id.item_offs );	
	}
	break;
	...
	for( ndx=0 ; ndx < node_rec->node_header.index_count ; ndx++ ) 
	{
	    ...
	    swap4bytes( node_rec->index[ndx].data.internal_id.rec_no );	
	    swap4bytes( node_rec->index[ndx].data.internal_id.item_offs );	
	...
	{
	    swap4bytes( ridmap_rec->pointers[ndx].internal_id.rec_no );	
	    swap4bytes( ridmap_rec->pointers[ndx].internal_id.item_offs );
	    ndx++;
	}
	break;
