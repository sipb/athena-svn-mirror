...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmwcrwr.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:43 $"
#endif
#endif
...
for ( ndx=0 ; ndx<nargs ; ndx++ )
    ...
    argdesc->args[ndx].arg_val.datum.ival = 0 ;
    }
 ...
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetCompressedArgTag", 0) ;
UrmCWR__BindArgPtrs
 ...
 * Validate record, arglist descriptor, and argument number
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetUncompressedArgTag", 0) ;
UrmCWR__BindArgPtrs
 ...
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetArgValue", 0) ;
UrmCWR__BindArgPtrs
 ...
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetArgResourceRef", 0) ;
UrmCWR__BindArgPtrs
 ...
 * Validate record, arglist descriptor, and argument number.
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetArgChar8Vec", 0) ;
UrmCWR__BindArgPtrs
 ...
 * Validate record, arglist descriptor, and argument number.
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetArgCStringVec", 0) ;
UrmCWR__BindArgPtrs
...
for ( ndx=0 ; ndx<nitems ; ndx++ )
    ...
    cbdesc->item[ndx].cb_item.datum.ival = 0 ;
    }
...
switch ( type )
    ...
    case MrmRtypeBoolean:
    case MrmRtypeSingleFloat:
        itmptr->cb_item.datum.ival = (long) itm_val ;
        return MrmSUCCESS ;
    case MrmRtypeChar8:
    case MrmRtypeAddrName:
    case MrmRtypeTransTable:
 ...
 */
UrmCWR__ValidateContext (context_id, "UrmCWRSetExtraArgs", 0) ;
UrmCWR__BindArgPtrs
