...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: MrmItopw.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:42 $"
#endif
#endif
 ...
 * issues.
 */
result = Idb__FU_OpenFile(name, URMWriteAccess, os_ext, &fileid, fname_return) ;
