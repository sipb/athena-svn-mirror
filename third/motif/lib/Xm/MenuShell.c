...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: MenuShell.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:53 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
    ...
    if(    ms->menu_shell.default_font_list    )
      {
        ms->menu_shell.default_font_list = XmFontListCopy(
