...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Manager.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:53 $"
#endif
#endif
/*
...
static XtAccelerators parsed = NULL;
        ...
        if(    XmIsBulletinBoard( ancestor)    )
          {
		    ...
		    /* fix for CR 10023 */
                    if (!parsed)
                      parsed = XtParseAcceleratorTable(
