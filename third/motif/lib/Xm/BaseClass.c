...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: BaseClass.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:44 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
    ...
    if (*wcePtr && (*wcePtr)->initializePosthook)
	  ...
	  if (!XtIsShell(new_w) && XtParent(new_w) && XtIsConstraint(XtParent(new_w)))
		...
		leafFuncPtr = (XtInitProc *) &(cwc->constraint_class.initialize);
                /* CR 7738: Bullet-proofing. */
