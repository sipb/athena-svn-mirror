...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Traversal.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:17:07 $"
#endif
#endif
#ifdef  REV_INFO
#ifndef lint
		...
		if ((callbacks = vendorExt->vendor.focus_moved_callback) != NULL)
		  {
		      ...
		      callData.reason		= /* XmCR_FOCUS_MOVED */ 48;
               ...
               if( type != XmTAB_GROUP)
               {
                ...
                last=second_last=0;
                   ...
                   do
                   {
                        ...
                        second_last=last;
                        last=_XmTraverse( trav_list,XmTRAVERSE_PREV,
