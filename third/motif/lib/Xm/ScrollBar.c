...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: ScrollBar.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:59 $"
#endif
#endif
/*
	...
	{ XmNdragCallback, XmCCallback,
	  ...
	  XmRPointer, (XtPointer) NULL
        ...
        },
        {
          ...
          XmRCallProc, (XtPointer) _XmSetThicknessDefault0
        },
};
...
#endif /* _NO_PROTO */
{
	...
	if (!XtIsSensitive(nw)) returnFlag = TRUE;
    }
