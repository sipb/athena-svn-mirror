...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: XmString.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:17:08 $"
#endif
#endif
/*
...
{   
    ...
    if (strlen(XmFONTLIST_DEFAULT_TAG) == length && 
	strncmp(charset, XmFONTLIST_DEFAULT_TAG, length) == 0)
      {
...
static void 
#ifdef _NO_PROTO
_calc_align_and_clip( d, gc, x, y, width, line_width, lay_dir, clip, align, descender, ascender, restore )
        Display *d ;
        GC gc ;
        Position *x ;
        Position y ;
        ...
        if (line_width != 0)
          {   
            ...
            _calc_align_and_clip( d, gc, &draw_x, y, width, line_width, 
                                lay_dir, clip, align, descender, ascender,
                                &restore_clip) ;
