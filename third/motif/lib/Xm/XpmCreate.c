...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: XpmCreate.c,v $"
#endif
#endif
...
/* Since we introduce the colorCache functionality,
 * the original purpose of pixels/npixels is gone.
 * npixels (renamed as num_image_pixels) is now the number of colors in the 
 * colorTable of the Image that are successfully found so far.
 */
#undef RETURN
#ifdef Debug
/*
