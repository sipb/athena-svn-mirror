...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: XpmRgb.c,v $"
#endif
#endif
...

{
	...
	for (n = name, m = rgbname; *n; n++)
	    *m++ = isupper((unsigned char)*n) ? tolower((unsigned char)*n) : *n;
	*m = '\0';
...
/*
 * Free the strings which have been malloc'ed in _XmxpmReadRgbNames
 */
void
