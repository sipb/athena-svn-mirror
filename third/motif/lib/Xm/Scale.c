...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Scale.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:51 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
	...
	if (XtIsRealized((Widget)new_w) && NeedNewSize(cur, new_w))
	{
		/*
	...
	if (XtIsRealized((Widget)new_w) &&
		((new_w->scale.decimal_points != cur->scale.decimal_points) ||
	...
	if (XtIsRealized((Widget)new_w) &&
		((new_w->manager.foreground != cur->manager.foreground) ||
