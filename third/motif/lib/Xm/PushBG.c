...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: PushBG.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:54 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
       ...
       LabG_MenuType(pb) == XmMENU_POPUP)
   {
      ...
      if (!PBG_Armed(pb) && PBG_ArmCallback(pb))
      {
	 XFlush (XtDisplay (pb));
...
#endif /* _NO_PROTO */
{
       ...
       LabG_MenuType(pb) == XmMENU_POPUP)
   {
      ...
      if (PBG_Armed(pb) && PBG_DisarmCallback(pb))
      {
	 XFlush (XtDisplay (pb));
...
#endif /* _NO_PROTO */
{
   ...
   if (XtIsRealized(pb))
   {
	 ...
	 if (PBG_Armed(pb))
	   (*(((XmPushButtonGadgetClass) XtClass( pb))
	       ->gadget_class.border_highlight))( (Widget) pb) ;
#endif
      }
      else
      {
...
#endif
	 _XmDrawShadows (XtDisplay (pb), XtWindow (pb),
			  bottomgc, topgc, dx, dy, width, height,
...
#endif /* _NO_PROTO */
{
  ...
  Window root;
  int  x, y;
  unsigned int  onW = 0, onH = 0, border, d;
