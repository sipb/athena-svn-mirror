...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: ResConvert.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:57 $"
#endif
#endif
/*
...
/* BEGIN OSF Fix CR 7403 */
  while ((comp = XmStringGetNextComponent(context, 
	...
	if (cset_save == NULL)
	  cset_save = charset;
	else if (cset_save != XmFONTLIST_DEFAULT_TAG &&
		strcmp(cset_save, charset) != 0)
	  {
	    XtFree(cset_save);
	    cset_save = charset;
	  }
