...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: VendorS.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:17:12 $"
#endif
#endif
/*
...
*/
    ...
    if(    ve->vendor.default_font_list    )
      {
        ve->vendor.default_font_list = XmFontListCopy(
...
#endif /* _NO_PROTO */
{
  ...
  while(    n < destroy_list_cnt    )
  {
	...
	if ((ve = (XmVendorShellExtObject) ext->widget) != NULL) {
	    ...
	    if (ve->vendor.default_font_list)
		XmFontListFree(ve->vendor.default_font_list);
