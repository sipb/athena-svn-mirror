...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: ScrolledW.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:17:02 $"
#endif
#endif
/*
...
#ifdef BREAKS_QATS
       /* Prevents override of keypad entries for 3,7,9 keys on HP PC keyboards */
        strcat(tmp,":");
#endif
