...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: DropSMgr.c,v $ $Revision: 1.1.1.1 $ $Date: 1999-01-30 03:16:48 $"
#endif
#endif
/*
...
#define MESSAGE10 _XmMsgDropSMgr_0010
...
#endif /* _NO_PROTO */
{
	...
	/* rohit - begin fix for CR 8939 */

	if (shellInfo && XtIsRealized(shell))

	/* rohit - end fix for CR 8939 */
...
#endif /* _NO_PROTO */
{
	...
	/* rohit - fix for CR 9338 */
	if (XtIsShell(widget))
	  {
#ifdef I18N_MSG
	    _XmWarning(widget, catgets(Xm_catd,MS_DropS,MSG_DRS_10, MESSAGE10));
#else
	    _XmWarning(widget, MESSAGE10);
#endif
	  }
	else
