...
struct _GtkGSClass
{
	...
	GdkAtom        string_atom;
        ...
        void (*document_changed)(GtkGS *, gpointer);
...
gboolean     gtk_gs_scroll_step(GtkGS *gs, GtkScrollType direction, gboolean dowrap);
gboolean     gtk_gs_scroll_to_edge(GtkGS *gs, GtkPositionType vertical, GtkPositionType horizontal);
...
void         gtk_gs_set_watch_file(GtkGS *gs, gboolean f);
gboolean     gtk_gs_get_watch_file(GtkGS *gs);
