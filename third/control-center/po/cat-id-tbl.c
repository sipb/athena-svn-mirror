...
aborting...\n", 4},
  ...
  {"Centered", 23},
  {"Tiled", 24},
  {"Use GNOME to set background", 25},
  {"Set parameters from saved state and exit", 26},
  {"IMAGE", 27},
  {"Sets the wallpaper to the value specified", 28},
  {"COLOR", 29},
  {"Specifies the background color", 30},
  {"Specifies end background color for gradient", 31},
  {"ORIENT", 32},
  {"Gradient orientation: vertical or horizontal", 33},
  {"Use a solid fill for the background", 34},
  {"Use a gradient fill for the background", 35},
  {"MODE", 36},
  {"Display wallpaper: tiled, centered, scaled or ratio", 37},
  {"Desktop", 38},
  {"Configure how document types are handled", 39},
  {"Document Handlers", 40},
  {"Control Center", 41},
  {"Control Center Menu", 42},
  {"Configure the settings of your Multimedia devices", 43},
  {"Multimedia", 44},
  {"Configure your external devices", 45},
  {"Peripherals", 46},
  {"Session", 47},
  {"Session Management Settings", 48},
  {"Configure the global settings of your GNOME applications", 49},
  {"User Interface", 50},
  {"Edit Applications List", 51},
  {"Select applications to appear in menu for MIME type \"%s\"", 52},
  {"Add Application...", 53},
  {"Edit Application...", 54},
  {"Delete Application", 55},
  {"Edit Components List", 56},
  {"Select views to appear in menu for MIME type \"%s\"", 57},
  {"\
The MIME type entered contained upper case characters. Upper case characters \
were changed to lower case for you.", 58},
  {"Add New MIME Type", 59},
  {"Add MIME Type", 60},
  {"New MIME type (e.g. image/x-thumper):", 61},
  {"Description (e.g. Thumper image):", 62},
  {"File Extensions ", 63},
  {"Add...", 64},
  {"    Remove    ", 65},
  {"Add New Extension", 66},
  {"\
Type in the extensions for this mime-type (without dot).\n\
You can enter several extensions seperated by a space,\n\
for example: html htm", 67},
  {"Extension:", 68},
  {"You must enter a name.", 69},
  {"You must enter a command.", 70},
  {"\
\"%s\" does not exist or is not executable.\n\
Check your spelling and make sure you have\n\
the right permissions to execute this file.", 71},
  {"\
The command \"%s\" cannot be found.\n\
You must use a command that can work from any command line.", 72},
  {"Bad Application Name", 73},
  {"Bad Application Command", 74},
  {"Add Application", 75},
  {"Edit Application", 76},
  {"Application Name:", 77},
  {"Application Command:", 78},
  {"Open Behavior", 79},
  {"Can open multiple files", 80},
  {"Can open from URI", 81},
  {"MIME Type", 82},
  {"Change Icon", 83},
  {"Change File Extensions", 84},
  {"Default Action:", 85},
  {"Use Viewer", 86},
  {"Open With Application", 87},
  {"Edit List", 88},
  {"Add New MIME Type...", 89},
  {"Delete This MIME Type", 90},
  {"Revert to System Defaults", 91},
  {"None", 92},
  {"\
...
Revert anyway?", 93},
  ...
  {"Extension", 96},
  {"Default Action", 97},
  {"File Types and Programs", 98},
  {"Specify which programs are used to open or view each file type", 99},
  {"Select an icon", 100},
  {"Gnome editor", 101},
  {"Run In Terminal", 102},
  {"Choose the editor that is invoked by gnome-edit", 103},
  {"Default Editor", 104},
  {"Keyboard bell", 105},
  {"Volume", 106},
  {"Pitch (Hz)", 107},
  {"Duration (ms)", 108},
  {"Test", 109},
  {"Keyboard repeat rate", 110},
  {"Enable auto-repeat", 111},
  {"Repeat rate", 112},
  {"Repeat Delay", 113},
  {"Keyboard click", 114},
  {"Click on keypress", 115},
  {"Click volume", 116},
  {"Test settings", 117},
  {"\
No help is available/installed for these settings. Please make sure you\n\
have the GNOME User's Guide installed on your system.", 118},
  {"Close", 119},
  {"\
an initialization error occurred while starting \
