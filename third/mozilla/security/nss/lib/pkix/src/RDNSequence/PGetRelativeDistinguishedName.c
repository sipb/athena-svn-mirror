...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /afs/dev.mit.edu/source/repository/third/mozilla/security/nss/lib/pkix/src/RDNSequence/PGetRelativeDistinguishedName.c,v $ $Revision: 1.1.1.3 $ $Date: 2003-12-24 16:37:06 $ $Name: not supported by cvs2svn $";
#endif /* DEBUG */
