...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /afs/dev.mit.edu/source/repository/third/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/PSetValue.c,v $ $Revision: 1.1.1.1.2.1 $ $Date: 2003-07-14 19:07:10 $ $Name: not supported by cvs2svn $";
#endif /* DEBUG */
