...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /afs/dev.mit.edu/source/repository/third/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/PEqual.c,v $ $Revision: 1.1.1.3 $ $Date: 2003-12-24 16:35:29 $ $Name: not supported by cvs2svn $";
#endif /* DEBUG */
