...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /afs/dev.mit.edu/source/repository/third/mozilla/security/nss/lib/pkix/src/RelativeDistinguishedName/RemoveAttributeTypeAndValue.c,v $ $Revision: 1.1.1.2 $ $Date: 2003-07-08 18:51:29 $ $Name: not supported by cvs2svn $";
#endif /* DEBUG */
