...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /afs/dev.mit.edu/source/repository/third/mozilla/security/nss/lib/pkix/src/Attribute/PSetValue.c,v $ $Revision: 1.1.1.2 $ $Date: 2003-07-08 18:50:21 $ $Name: not supported by cvs2svn $";
#endif /* DEBUG */
