/*
 * $Source: /afs/transarc.com/project/fs/dev/afs/rcs/des/RCS/des_conf.h,v $
 * $Author: vasilis $
 * $Header: /afs/transarc.com/project/fs/dev/afs/rcs/des/RCS/des_conf.h,v 2.6 1993/11/11 16:42:34 vasilis Exp $
 *
