...
typedef struct ResidencyCmdInputs ResidencyCmdInputs;
bool_t xdr_ResidencyCmdInputs();
...
typedef struct ResidencyCmdOutputs ResidencyCmdOutputs;
bool_t xdr_ResidencyCmdOutputs();

#define RXAFS_STATINDEX 7

/* Opcode-related useful stats for package: RXAFS_ */
#define RXAFS_LOWEST_OPCODE   130
#define RXAFS_HIGHEST_OPCODE	220
#define RXAFS_NUMBER_OPCODES	35

#define RXAFS_NO_OF_STAT_FUNCS	35
