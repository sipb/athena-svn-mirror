...
/*
 * struct diskPartition field notes:
 *
 * not_meaningful - formerly named totalUsable.  It was not initialized.
 *
 * free - total free disk space (1KB blocks)
 *
 * minFree - total usable disk space (1KB blocks)  (yes, it's a poor name)
 */
