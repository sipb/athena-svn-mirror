...
typedef struct AFSSysname AFSSysname;
bool_t xdr_AFSSysname();
...
#define RXAFSCB_HIGHEST_OPCODE	219
#define RXAFSCB_NUMBER_OPCODES	16

#define RXAFSCB_NO_OF_STAT_FUNCS	16
