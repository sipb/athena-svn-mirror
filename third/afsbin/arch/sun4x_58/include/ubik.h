...
/* $Header: /afs/dev.mit.edu/source/repository/third/afsbin/arch/sun4x_58/include/ubik.h,v 1.1.1.1 2001-03-16 16:41:15 ghudson Exp $ */
/* $Source: /afs/dev.mit.edu/source/repository/third/afsbin/arch/sun4x_58/include/ubik.h,v $ */

#ifndef UBIK_H
#define UBIK_H

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsidlock = "$Header: /afs/dev.mit.edu/source/repository/third/afsbin/arch/sun4x_58/include/ubik.h,v 1.1.1.1 2001-03-16 16:41:15 ghudson Exp $";
#endif
...
extern int multiDISKAbort();
extern int multiDISKBegin();
extern int multiDISKReleaseLocks();
extern int multiDISKCommit();
extern int multiDISKLock();
/* extern int DISK_Write(); NO LONGER USED */ 
extern int multiDISKWriteV();
extern int multiDISKTruncate();
extern int multiDISKSetVersion();
