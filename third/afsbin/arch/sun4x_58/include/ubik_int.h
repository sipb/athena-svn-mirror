...
#define multi_DISK_Begin(tid) \
	multi_Body(StartDISK_Begin(multi_call, tid), EndDISK_Begin(multi_call))


#define multi_DISK_Commit(tid) \
	multi_Body(StartDISK_Commit(multi_call, tid), EndDISK_Commit(multi_call))


#define multi_DISK_Lock(tid, file, position, length, type) \
	multi_Body(StartDISK_Lock(multi_call, tid, file, position, length, type), EndDISK_Lock(multi_call))


#define multi_DISK_Abort(tid) \
	multi_Body(StartDISK_Abort(multi_call, tid), EndDISK_Abort(multi_call))


#define multi_DISK_ReleaseLocks(tid) \
	multi_Body(StartDISK_ReleaseLocks(multi_call, tid), EndDISK_ReleaseLocks(multi_call))


#define multi_DISK_Truncate(tid, file, length) \
	multi_Body(StartDISK_Truncate(multi_call, tid, file, length), EndDISK_Truncate(multi_call))
...
#define multi_DISK_WriteV(tid, io_vector, io_buffer) \
	multi_Body(StartDISK_WriteV(multi_call, tid, io_vector, io_buffer), EndDISK_WriteV(multi_call))
...
#define multi_DISK_SetVersion(tid, OldVersion, NewVersion) \
	multi_Body(StartDISK_SetVersion(multi_call, tid, OldVersion, NewVersion), EndDISK_SetVersion(multi_call))
