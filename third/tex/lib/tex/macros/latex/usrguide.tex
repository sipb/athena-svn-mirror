...
\author{\copyright~Copyright 1995--1997, \LaTeX3 Project Team.\\
   All rights reserved.}
...
Articles covering aspects of the \LaTeX3 project are available for
anonymous ftp from the Comprehensive \TeX{} Archive, in the directory:
\begin{verbatim}
