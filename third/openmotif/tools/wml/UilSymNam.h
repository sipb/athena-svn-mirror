...
externaldef(uil_sym_glbl) int uil_max_object = 74;
...
externaldef(uil_sym_glbl) int uil_max_arg = 564;
...
externaldef(uil_sym_glbl) int uil_max_reason = 67;
...
externaldef(uil_sym_glbl) int uil_max_enumset = 98;
externaldef(uil_sym_glbl) int uil_max_enumval = 342;
...
externaldef(uil_sym_glbl) int uil_max_child = 27;
