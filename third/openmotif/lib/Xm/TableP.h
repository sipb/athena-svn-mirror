 ...
 * Revision 1.4  2002/01/15 17:30:42  rhartley
 * Extra files for the v2.2 widget additions
 *
 * Revision 1.7  2001/03/26 21:43:34  jimk
 * finished parts offsetting which was never done correctly
 *
 * Revision 1.6  1999/10/29 20:19:10  sridhar
 * Changes for Motif 2.1
 *
 * Revision 1.5  1997/09/30 18:08:52  andy
 * Whoops.  Typo.
 *
 * Revision 1.4  1997/08/15 11:15:41  dbl
 * move field
 *
 * Revision 1.3  97/06/30  11:56:14  dbl
 * unnumbered:
 * 
 * Revision 1.2  97/06/18  20:07:12  andy
 * Initial offseted version
 * 
 * Revision 1.1  1997/05/23 20:38:52  andy
 * Initial revision
 *
 * Revision 1.1  95/11/21  17:05:17  dkb
 * Initial revision
 * 
 * Revision 1.4  95/06/01  10:35:11  dkb
 * changes to just Xi
 * 
 * Revision 1.3  95/05/30  16:40:20  dkb
 * make multiple libs, including renamed
 * 
 * Revision 1.2  95/05/18  16:44:32  dkb
 ...
 * Initial revision
 * 
 * Revision 1.1.2.7  1995/05/05  16:01:09  dkb
 * 	Make listen to traversalOn and sensitive
 * 	[1995/05/05  16:00:35  dkb]
 *
 * Revision 1.1.2.6  1995/05/01  15:44:05  dkb
 ...
 * 	[1995/05/01  15:43:41  dkb]
 * 
 * Revision 1.1.2.5  1995/04/17  20:17:40  dkb
 * 	Added an append mode for default procs and fixed some bugs
 * 	[1995/04/17  20:14:33  dkb]
 * 
 * Revision 1.1.2.4  1995/04/10  18:38:37  dkb
 * 	various changes and bug fixes to Table and DBTable
 * 	[1995/04/10  18:35:39  dkb]
 * 
 * Revision 1.1.2.3  1995/04/05  21:46:22  dkb
 * 	Changes to resize requests
 * 	[1995/04/05  21:46:03  dkb]
 * 
 * Revision 1.1.2.2  1995/03/31  19:16:51  dkb
 * 	Added a font list and did some KR vs ANSI stuff
 * 	[1995/03/31  19:13:30  dkb]
 * 
 * Revision 1.1.2.1  1995/03/30  16:58:48  dbl
 * 	move P.h to widgets/qd
 * 	[1995/03/30  16:55:54  dbl]
 * 
 * Revision 1.1.2.3  1995/03/29  23:14:42  dkb
 * 	fixed(sped up scrolling)
 * 	[1995/03/29  23:14:29  dkb]
 * 
 * Revision 1.1.2.2  1995/03/28  16:34:00  dkb
 * 	Added a new callbacks and changed some macros(cosmeticly)
 * 	[1995/03/28  16:03:51  dkb]
 * 
 * Revision 1.1.2.1  1995/03/24  19:14:00  dkb
 * 	Initial check in of the new Table widget stuff
 * 	[1995/03/24  18:55:20  dkb]
 * 
 * $EndLog$
 */
