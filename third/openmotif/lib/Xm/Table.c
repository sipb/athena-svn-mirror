 ...
 * Revision 1.5  2002/01/15 17:30:40  rhartley
 * Extra files for the v2.2 widget additions
 *
 * Revision 1.13  2001/06/22 21:03:10  jimk
 * fix for PPC
 *
 * Revision 1.12  2001/03/27 15:06:31  jimk
 * fixed parts offsetting problem
 *
 * Revision 1.11  1999/11/05 22:22:44  scott
 * Changes to compile cleanly with Motif 2.1
 *
 * Revision 1.10  1998/06/18 14:40:25  andy
 * Whoops, forgot to declare ClipClassInitialize in both halves of the
 * declaration block.  SunOS and Solaris builds evidently are done in
 * K&R style (??)
 *
 * Revision 1.9  1998/06/17 15:34:49  andy
 * Offseted the XmTableClip class, which got missed the first time.  See
 * notes at top of file for caveats.
 *
 * Revision 1.8  1998/06/10 15:59:43  andy
 * Merged in changes from EPak 2.5.2 (DBPak) tree
 *
 * Revision 1.7  1998/03/25 16:49:38  andy
 * Fixed renaming behavior
 *
 * Revision 1.6  1997/07/18 16:07:23  dbl
 * CR02878: bad use of XmRPixmap
 *
 * Revision 1.5  1997/07/02 16:52:37  dbl
 * XtCallCallbacks  -> XtCallCallbackList
 *
 * Revision 1.4  97/06/30  11:56:13  dbl
 * unnumbered:
 *
 * Revision 1.3  97/06/18  20:07:21  andy
 * Initial offseted version
 *
 * Revision 1.2  1997/06/18 15:02:07  dbl
 * fix missing data return values.
 *
 * Revision 1.1  97/05/23  20:38:22  andy
 * Initial revision
 *
 * Revision 1.1  95/11/21  17:05:17  dkb
 * Initial revision
 *
 * Revision 1.11  95/11/20  16:00:33  dkb
 * typo
 *
 * Revision 1.10  95/11/20  14:29:19  dkb
 * added XFontSet handling code
 *
 * Revision 1.9  95/11/16  14:57:10  dkb
 * Table was not assigning the default free proc, now it is (thanks Mike)
 *
 * Revision 1.8  95/08/21  11:29:57  dkb
 * fix up K&R function headers
 *
 * Revision 1.7  95/08/15  13:34:00  dbl
 * ifdef -> if
 *
 * Revision 1.6  95/06/01  10:35:06  dkb
 * changes to just Xi
 *
 * Revision 1.5  95/05/30  16:40:16  dkb
 * make multiple libs, including renamed
 *
 * Revision 1.4  95/05/23  13:58:47  dkb
 * *** empty log message ***
 *
 * Revision 1.3  95/05/23  11:49:57  dkb
 * Got rid of some nasty color generation stuff that does not work right
 * in the set values
 *
 * Revision 1.2  95/05/18  16:44:30  dkb
 * Initial library version - May 18, 1995
 *
 * Revision 1.1  95/05/18  09:43:36  dkb
 * Initial revision
 *
 * Revision 1.1  95/05/17  09:39:29  dkb
 * Initial revision
 *
 * Revision 1.1.2.15  1995/05/05  16:01:05  dkb
 * 	Make listen to traversalOn and sensitive
 * 	[1995/05/05  16:00:27  dkb]
 *
 * Revision 1.1.2.14  1995/05/03  14:44:01  dkb
 * 	was oopsing because of a macro, now fixed
 * 	[1995/05/03  14:43:46  dkb]
 *
 * Revision 1.1.2.13  1995/05/01  15:44:01  dkb
 * 	Added a free cell value resource to the table to allow the user to specify a method to deallocate memory allocated in a fetch cell value
 * 	[1995/05/01  15:43:38  dkb]
 *
 * Revision 1.1.2.12  1995/04/25  14:31:59  dkb
 * 	fixed CR01541
 * 	[1995/04/25  14:31:38  dkb]
 *
 * Revision 1.1.2.11  1995/04/17  20:17:42  dkb
 * 	Added an append mode for default procs and fixed some bugs
 * 	[1995/04/17  20:14:36  dkb]
 *
 * Revision 1.1.2.10  1995/04/10  18:38:33  dkb
 * 	various changes and bug fixes to Table and DBTable
 * 	[1995/04/10  18:35:33  dkb]
 *
 * Revision 1.1.2.9  1995/04/07  21:50:09  dkb
 * 	fix a little opps
 * 	[1995/04/07  21:49:53  dkb]
 *
 * Revision 1.1.2.8  1995/04/05  21:46:18  dkb
 * 	Changes to resize requests
 * 	[1995/04/05  21:45:59  dkb]
 *
 * Revision 1.1.2.7  1995/04/03  22:55:46  dkb
 * 	Some table fixes
 * 	[1995/04/03  22:55:32  dkb]
 *
 * Revision 1.1.2.6  1995/03/31  19:42:28  dkb
 * 	I hate ode
 * 	[1995/03/31  19:42:12  dkb]
 *
 * Revision 1.1.2.5  1995/03/31  19:35:25  dkb
 * 	Merged with changes from 1.1.2.4
 * 	[1995/03/31  19:35:15  dkb]
 *
 * 	Added a font list and did some KR vs ANSI stuff
 * 	[1995/03/31  19:13:22  dkb]
 *
 * Revision 1.1.2.4  1995/03/30  16:58:44  dbl
 * 	move P.h to widgets/qd
 * 	[1995/03/30  16:55:49  dbl]
 *
 * Revision 1.1.2.3  1995/03/29  23:13:22  dkb
 * 	Various changes and fixes
 * 	[1995/03/29  23:09:30  dkb]
 *
 * Revision 1.1.2.2  1995/03/28  16:34:39  dkb
 * 	many changes
 * 	[1995/03/28  16:17:10  dkb]
 *
 * Revision 1.1.2.1  1995/03/24  19:31:10  dkb
 * 	Initial checkin
 * 	[1995/03/24  18:58:21  dkb]
 *
 * $EndLog$
 */
