 ...
 *
 *	$Source: /afs/dev.mit.edu/source/repository/third/gaim/src/protocols/zephyr/ZInit.c,v $
 *	$Author: ghudson $
 *
 ...
 *	"mit-copyright.h". 
 */
/* $Header: /afs/dev.mit.edu/source/repository/third/gaim/src/protocols/zephyr/ZInit.c,v 1.1.1.1 2005-06-15 16:40:33 ghudson Exp $ */
