 ...
 *
 *	$Source: /afs/dev.mit.edu/source/repository/third/gaim/src/protocols/zephyr/ZMkAuth.c,v $
 *	$Author: ghudson $
 *
 ...
 *	"mit-copyright.h". 
 */
/* $Id: ZMkAuth.c,v 1.1.1.1 2005-06-15 16:40:33 ghudson Exp $ */

#include "internal.h"

#ifndef lint
static const char rcsid_ZMakeAuthentication_c[] = "$Id: ZMkAuth.c,v 1.1.1.1 2005-06-15 16:40:33 ghudson Exp $";
#endif
