...
!define GAIM_IS_RUNNING			"Jelenleg fut a Gaim egy példánya. Lépjen ki a Gaimból és próbálja újra."
...
!define GAIM_DESKTOP_SHORTCUT_DESC   "Parancsikon létrehozása aGaimhoz az asztalon"
...
!define GAIM_PROMPT_WIPEOUT			"Az Ön korábbi Gaim könyvtára törölve lesz. Folytatni szeretné?$\r$\rMegjegyzés: Minden Ön által telepített bõvítmény törölve lesz.$\rA Gaim felhasználói beállításokra ez nincs hatással."
