...
/* declared in krb.h */
#ifdef IGNORE_IP_ADDRESS
int krb_ignore_ip_address = 1;
#else
    ...
    char *fn;			/* Filename to get keys from */
{
    ...
    unsigned KRB_INT32 r_time_sec;   /* Coarse time from authenticator */
    register char *ptr;		/* For stepping through */
    unsigned KRB_INT32 t_local;	/* Local time on our side of the protocol */
    KRB_INT32 delta_t;      	/* Time in authenticator minus local time */
    KRB_INT32 tkt_age;		/* Age of ticket */
