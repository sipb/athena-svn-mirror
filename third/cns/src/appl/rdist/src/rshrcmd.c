...
#ifndef lint
static char RCSid[] = 
"$Id: rshrcmd.c,v 1.1.1.1 1996-09-06 00:46:17 ghudson Exp $";
#endif
 ...
 */
rshrcmd(ahost, port, luser, ruser, cmd, fd2p, encrypt)
	char  	**ahost;
	u_short	port;
	...
	int	encrypt;
{
	...
	if (cpid == 0) {
		...
		if (strcmp(*ahost, "localhost") == 0 &&
			...
			execlp(_PATH_BSHELL, rdist_basename(_PATH_BSHELL), "-c",
			       cmd, (char *) NULL);
