					...
					int PercentV)
{
	...
	dummy = (char *)getA5();
	dummy = *(char **)dummy;
	dummy -= (5*sizeof(Pattern) + sizeof(Cursor) + sizeof(BitMap));
	ScreenBits = (BitMap *)dummy;
	
	ScreenRect = ScreenBits->bounds;
	ScreenRect.top += *(short *)MBarHeight;
