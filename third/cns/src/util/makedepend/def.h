...
#define EJECT		11
#define IDENT		12
#define TOK_LAST	IDENT
#define	IFFALSE		(TOK_LAST+1)	/* pseudo value --- never matched */
#define ELIFFALSE	(TOK_LAST+2)	/* pseudo value --- never matched */
#define	INCLUDEDOT	(TOK_LAST+3)	/* pseudo value --- never matched */
