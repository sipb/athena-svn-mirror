 ...
 *------------------------------------------------------------------
 *
 * $Source: /afs/dev.mit.edu/source/repository/third/cns/src/util/ss/test.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 1996-09-06 00:48:00 $
 * $State: Exp $
 * $Author: ghudson $
 * $Locker:  $
 *
 * $Log: not supported by cvs2svn $
 * Revision 1.1  1996/06/24 20:52:54  ghudson
 * Initial revision
 *
...
static char const rcsid_test_c[] =
    "$Header: /afs/dev.mit.edu/source/repository/third/cns/src/util/ss/test.c,v 1.1.1.1 1996-09-06 00:48:00 ghudson Exp $";
#endif /* lint */
