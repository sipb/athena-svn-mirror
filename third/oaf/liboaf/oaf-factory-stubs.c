...
void
_ORBIT_GNOME_ObjectFactory_CannotActivate_demarshal(GIOPRecvBuffer *
						    _ORBIT_recv_buffer,
				 ...
				 CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && GNOME_ObjectFactory__classid) {
      _ORBIT_retval =
	 ((POA_GNOME_ObjectFactory__epv *) _obj->
	  vepv[GNOME_ObjectFactory__classid])->manufactures(_obj->servant,
							    obj_oaf_id, ev);
 ...
 _ORBIT_retry_request:
   ...
   {				/* marshalling */
	 ...
	 goto _ORBIT_system_exception;
      _ORBIT_tmpvar_1 = strlen(obj_oaf_id) + 1;
	 ...
	 giop_message_buffer_append_mem(GIOP_MESSAGE_BUFFER
      ...
      giop_message_buffer_append_mem(GIOP_MESSAGE_BUFFER(_ORBIT_send_buffer),
				     (obj_oaf_id),
				     sizeof(obj_oaf_id[_ORBIT_tmpvar_0]) *
				     _ORBIT_tmpvar_1);
...
CORBA_Object
GNOME_ObjectFactory_create_object(GNOME_ObjectFactory _obj,
				  const CORBA_char * oaf_id,
				  const GNOME_stringlist * params,
				  CORBA_Environment * ev)
{
   static const ORBit_exception_demarshal_info _ORBIT_user_exceptions[] =
      { {(const CORBA_TypeCode) &TC_GNOME_ObjectFactory_CannotActivate_struct,
	 (gpointer) _ORBIT_GNOME_ObjectFactory_CannotActivate_demarshal},
   ...
   if (_obj->servant && _obj->vepv && GNOME_ObjectFactory__classid) {
      _ORBIT_retval =
	 ((POA_GNOME_ObjectFactory__epv *) _obj->
	  vepv[GNOME_ObjectFactory__classid])->create_object(_obj->servant,
							     oaf_id, params,
							     ev);
      return _ORBIT_retval;
   }
 ...
 _ORBIT_retry_request:
   ...
   {				/* marshalling */
	 ...
	 giop_send_request_buffer_use(_cnx, NULL, _ORBIT_request_id,
      ...
      if (!_ORBIT_send_buffer)
	 goto _ORBIT_system_exception;
      _ORBIT_tmpvar_1 = strlen(oaf_id) + 1;
      giop_message_buffer_do_alignment(GIOP_MESSAGE_BUFFER
				       (_ORBIT_send_buffer), 4);
      {
	 guchar *_ORBIT_t;
...
void
GNOME_ObjectFactory_ref(GNOME_ObjectFactory _obj, CORBA_Environment * ev)
{
   register GIOP_unsigned_long _ORBIT_request_id,
    _ORBIT_system_exception_minor;
   register CORBA_completion_status _ORBIT_completion_status;
   ...
   if (_obj->servant && _obj->vepv && GNOME_ObjectFactory__classid) {
	 ...
	 ((POA_GNOME_ObjectFactory__epv *) _obj->
       vepv[GNOME_ObjectFactory__classid])->ref(_obj->servant, ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
 _ORBIT_retry_request:
...
void
GNOME_ObjectFactory_unref(GNOME_ObjectFactory _obj, CORBA_Environment * ev)
{
   register GIOP_unsigned_long _ORBIT_request_id,
    _ORBIT_system_exception_minor;
   register CORBA_completion_status _ORBIT_completion_status;
   ...
   if (_obj->servant && _obj->vepv && GNOME_ObjectFactory__classid) {
	 ...
	 ((POA_GNOME_ObjectFactory__epv *) _obj->
       vepv[GNOME_ObjectFactory__classid])->unref(_obj->servant, ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
   _ORBIT_send_buffer = NULL;
