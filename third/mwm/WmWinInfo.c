...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: WmWinInfo.c,v $ $Revision: 1.1.1.1 $ $Date: 1997-03-25 09:12:28 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
	...
	if (flags & IconPixmapHint)
	{
	    ...
	    if ((iconPixmap = 
		 MakeClientIconPixmap (pCD, pXWMHints->icon_pixmap)) != None)
	    {
		/*
