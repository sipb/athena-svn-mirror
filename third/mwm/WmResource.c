...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: WmResource.c,v $ $Revision: 1.1.1.1 $ $Date: 1997-03-25 09:12:26 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
	...
	sprintf(msg, "failed to load font: %.100s", (char*) pAData->fontList);
	Warning(msg);
	exit(WM_ERROR_EXIT_VALUE);
    }
    ...
    {
	char msg[130];
	sprintf(msg, "cannot find an appropriate font: %.100s",
