...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: WmResParse.c,v $ $Revision: 1.1.1.1 $ $Date: 1997-03-25 09:12:24 $"
#endif
#endif
/*
...
#endif /* _NO_PROTO */
{
    ...
    /*
     * The first call (setlocale(LC_ALL,"")) probably is not needed -- I
     * think X/Xt initialization does that.  It is, however, harmless to do
     * it here.  I'll take it out when someone assures me it is not needed,
     * and tells me how it really does get accomplished.
     */
    setlocale(LC_ALL, "");
