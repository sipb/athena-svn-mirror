...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: WmColormap.c,v $ $Revision: 1.1.1.1 $ $Date: 1997-03-25 09:12:17 $"
#endif
#endif
/*
...
#ifndef OLD_COLORMAP
void    ForceColormapFocus ();
#endif
void	SetColormapFocus ();
void	WmInstallColormap ();
void	ProcessColormapList();
 ...
 * the root window).
 *
 * The reason is to permit focus to be coerced.  We need to do this because
