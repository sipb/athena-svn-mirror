...
#if NAMED_BIND
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.1 2003-04-08 15:08:48 zacheiss Exp $ (with name server)")
#else /* NAMED_BIND */
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.1 2003-04-08 15:08:48 zacheiss Exp $ (without name server)")
#endif /* NAMED_BIND */
