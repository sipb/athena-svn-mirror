...
void
_ORBIT_GNOME_Table_OutOfRange_demarshal(GIOPRecvBuffer * _ORBIT_recv_buffer,
		...
		CORBA_Environment * ev)
{
   static const ORBit_exception_demarshal_info _ORBIT_user_exceptions[] =
	 ...
	 (gpointer) _ORBIT_GNOME_Table_OutOfRange_demarshal},
   ...
   if (_obj->servant && _obj->vepv && GNOME_Table__classid) {
      _ORBIT_retval =
	 ((POA_GNOME_Table__epv *) _obj->vepv[GNOME_Table__classid])->
 ...
 _ORBIT_retry_request:
   ...
   {				/* demarshalling */
	 ...
	 _ORBIT_curptr = ALIGN_ADDRESS(_ORBIT_curptr, 2);
	 (*_ORBIT_retval)._d = *((CORBA_short *) _ORBIT_curptr);
	 _ORBIT_curptr += 2;
	 switch ((*_ORBIT_retval)._d) {
	   case 2:
	    _ORBIT_curptr = ALIGN_ADDRESS(_ORBIT_curptr, 8);
...
CORBA_long
GNOME_Table_set(GNOME_Table _obj, const CORBA_long col, const CORBA_long row,
		const GNOME_Table_Value * val, CORBA_Environment * ev)
{
   static const ORBit_exception_demarshal_info _ORBIT_user_exceptions[] =
      { {(const CORBA_TypeCode) &TC_GNOME_Table_OutOfRange_struct,
	 (gpointer) _ORBIT_GNOME_Table_OutOfRange_demarshal},
