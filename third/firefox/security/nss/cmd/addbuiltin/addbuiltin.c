 ...
 *
 * $Id: addbuiltin.c,v 1.1.1.4 2005-07-26 17:42:17 rbasch Exp $
 */
...
printheader() {
    printf("# \n"
     ...
     "# GPL.\n"
     "#\n"
     "CVS_ID \"@(#) $RCSfile: addbuiltin.c,v $ $Revision: 1.1.1.4 $ $Date: 2005-07-26 17:42:17 $ $Name: not supported by cvs2svn $\"\n"
     "\n"
     "#\n"
     "# certdata.txt\n"
     "#\n"
