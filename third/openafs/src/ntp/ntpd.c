...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/ntp/ntpd.c,v 1.1.1.1 2002-01-31 21:50:15 zacheiss Exp $");
	...
	char *argv[];
{
	...
	syslog(LOG_NOTICE, "%s version $Revision: 1.1.1.1 $", prog_name);
	syslog(LOG_NOTICE, "patchlevel %d", PATCHLEVEL);

#ifdef	DEBUG
	if (debug)
		printf("%s version $Revision: 1.1.1.1 $ patchlevel %d\n",
