...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/uss/uss_common.c,v 1.1.1.1 2002-01-31 21:49:30 zacheiss Exp $");
...
char *uss_common_FieldCp(a_to, a_from, a_separator, a_maxChars, a_overflowP)
    char *a_to;
    char *a_from;
    char a_separator;
    int a_maxChars;
