...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/libadmin/samples/rxstat_disable_process.c,v 1.1.1.2 2004-02-13 17:57:23 zacheiss Exp $");
...
{
    fprintf(stderr,
	    "Usage: rxstat_disable_process <cell> <host> <port>\n");
    exit(1);
}
