...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/libadmin/samples/rxdebug_supported_stats.c,v 1.1.1.1 2002-01-31 21:49:09 zacheiss Exp $");
