...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/libadmin/samples/rxdebug_supported_stats.c,v 1.1.1.2 2004-02-13 17:57:23 zacheiss Exp $");
