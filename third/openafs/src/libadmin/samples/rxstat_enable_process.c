...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/libadmin/samples/rxstat_enable_process.c,v 1.1.1.2 2004-02-13 17:57:23 zacheiss Exp $");
...
int main(int argc, char *argv[])
{
    ...
    rc = util_RPCStatsStateEnable(conn, RXSTATS_EnableProcessRPCStats, &st);
    if (!rc) {
