/*
 * $Id: osi_sleep.c,v 1.1.1.1 2005-03-10 20:43:39 zacheiss Exp $
 */
...
RCSID
    ("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/afs/OBSD/osi_sleep.c,v 1.1.1.1 2005-03-10 20:43:39 zacheiss Exp $");
