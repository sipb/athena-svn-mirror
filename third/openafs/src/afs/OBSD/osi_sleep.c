/*
 * $Id: osi_sleep.c,v 1.1.1.2 2005-08-02 21:15:14 zacheiss Exp $
 */
...
RCSID
    ("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/afs/OBSD/osi_sleep.c,v 1.1.1.2 2005-08-02 21:15:14 zacheiss Exp $");
