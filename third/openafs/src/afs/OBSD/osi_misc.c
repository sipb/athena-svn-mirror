 ...
 * osi_misc.c
 *
 * $Id: osi_misc.c,v 1.1.1.1 2005-03-10 20:33:45 zacheiss Exp $
 */
...
RCSID
    ("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/afs/OBSD/osi_misc.c,v 1.1.1.1 2005-03-10 20:33:45 zacheiss Exp $");
