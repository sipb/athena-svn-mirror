...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/afs/HPUX/osi_file.c,v 1.1.1.1 2002-01-31 21:49:56 zacheiss Exp $");
    ...
    afs_int32 ainode;
{
    ...
    setuerror(0);
    AFS_GUNLOCK();
    ip = (struct inode *) igetinode(afs_cacheVfsp, (dev_t) cacheDev.dev, (ino_t)ainode,&dummy);
    AFS_GLOCK();
    if (getuerror()) {
...
retry_IO:
	...
	afs_Trace2(afs_iclSetp, CM_TRACE_READFAILED, ICL_TYPE_INT32, (afs_int32) resid,
		 ICL_TYPE_INT32, code);
	/*
