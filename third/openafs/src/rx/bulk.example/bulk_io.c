...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/rx/bulk.example/bulk_io.c,v 1.1.1.1 2002-01-31 21:49:21 zacheiss Exp $");
    ...
    register struct stat *status;
{
	...
	if (write(fd, buffer, nbytes) != nbytes) {
	    fprintf("File system write failed!\n");
	    error = BULK_ERROR;
	}
	length -= nbytes;
    }
