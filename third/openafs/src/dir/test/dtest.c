...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/dir/test/dtest.c,v 1.1.1.1 2002-01-31 21:50:07 zacheiss Exp $");
...
void Usage(void)
{
    ...
    printf("-f file name count - creates count names based on \"name\" in directory in file\n");
    ...
    char *name;
{
    dirhandle dir;
    OpenDir(name, &dir);
    if (DirOK(&dir)) printf("Directory ok.\n");
