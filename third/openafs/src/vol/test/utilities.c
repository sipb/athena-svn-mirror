...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/vol/test/utilities.c,v 1.1.1.1 2002-01-31 21:49:38 zacheiss Exp $");
...
popStack()
{
	if ( stackSize == 0 ) return 0;	/* stack empty */
