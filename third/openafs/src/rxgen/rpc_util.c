...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/rxgen/rpc_util.c,v 1.1.1.1 2002-01-31 21:50:24 zacheiss Exp $");
 ...
 */
void
expected4(exp1,exp2,exp3,exp4)
	tok_kind exp1,exp2,exp3,exp4;
{
