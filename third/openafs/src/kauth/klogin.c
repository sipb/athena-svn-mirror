...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/kauth/klogin.c,v 1.1.1.1.2.1 2003-01-03 18:53:04 ghudson Exp $");
  ...
  char **argv)
{
	...
	do {
		...
		if (usererr == -1 && *pwd->pw_passwd != '\0') {
			...
			if (strcmp(namep, pwd->pw_passwd)) invalid = TRUE;
		    }
#else
		    char *pp;
