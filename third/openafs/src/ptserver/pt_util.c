/* $Id: pt_util.c,v 1.1.1.2 2004-02-13 17:52:11 zacheiss Exp $ */
...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/ptserver/pt_util.c,v 1.1.1.2 2004-02-13 17:52:11 zacheiss Exp $");
