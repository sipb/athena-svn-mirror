/* $Id: pt_util.c,v 1.3 2005-03-10 22:16:53 zacheiss Exp $ */
...
RCSID
    ("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/ptserver/pt_util.c,v 1.3 2005-03-10 22:16:53 zacheiss Exp $");
