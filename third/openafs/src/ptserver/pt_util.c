/* $Id: pt_util.c,v 1.1.1.3 2005-03-10 20:46:34 zacheiss Exp $ */
...
RCSID
    ("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/ptserver/pt_util.c,v 1.1.1.3 2005-03-10 20:46:34 zacheiss Exp $");
