/* $Id: ubik.c,v 1.1.1.1 2002-01-31 21:49:17 zacheiss Exp $ */

#include <afsconfig.h>
#include <afs/param.h>

RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/ptserver/ubik.c,v 1.1.1.1 2002-01-31 21:49:17 zacheiss Exp $");
