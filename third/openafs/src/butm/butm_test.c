...
RCSID("$Header: /afs/dev.mit.edu/source/repository/third/openafs/src/butm/butm_test.c,v 1.1.1.2 2004-02-13 17:52:02 zacheiss Exp $");
...
start:
    ...
    code = tapeInfo.ops.readFileData(&tapeInfo, dataBlock, dataSize + 1, nBytes);
