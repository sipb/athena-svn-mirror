...
# Time-stamp: <02/06/02 21:02:10 popineau>
#
################################################################################
root_srcdir = ..\..
...
$(program): $(objects) $(win32)\dvips.res
	$(link) $(**) $(conlibs)
$(objdir)\afm2tfm.exe: $(objdir)\afm2tfm.obj $(win32)\afm2tfm.res
	$(link) $(**) $(conlibs)
# Omit LOADLIBES since no need to dynamically link with kpathsea.
$(objdir)\squeeze.exe: $(objdir)\squeeze.obj
	$(link) $(**) $(conlibs)
...
extraclean::
	-@$(del) afm2tfm.ps dvips.ps testdata\*.log
