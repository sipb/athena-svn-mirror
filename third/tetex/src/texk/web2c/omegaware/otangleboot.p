{2:}{4:}{$C-,A+,D-}{[$C+,D+]}{:4}
program OTANGLE(webfile,changefile,Pascalfile,pool);label 9999;const{8:}
bufsize=3000;maxbytes=45000;maxtoks=50000;maxnames=10000;maxtexts=10000;
hashsize=353;longestname=400;linelength=72;outbufsize=144;stacksize=100;
maxidlength=50;unambiglength=25;{:8}type{11:}ASCIIcode=0..255;{:11}{12:}
textfile=packed file of ASCIIcode;{:12}{37:}eightbits=0..255;
sixteenbits=integer;{:37}{39:}namepointer=0..maxnames;{:39}{43:}
...
end else if getoptreturnval=63 then begin usage(1,'otangle');
...
'J. Plaice, Y. Haralambous, D.E. Knuth');end;until getoptreturnval=-1;
if(optind+1<>argc)and(optind+2<>argc)then begin writeln(stderr,
'otangle: Need one or two file arguments.');usage(1,'otangle');end;
...
bytestart[3]:=0;nameptr:=1;stringptr:=65536;poolchecksum:=271828;{:42}
...
9999:if stringptr>65536 then{184:}begin begin writeln(stdout);
