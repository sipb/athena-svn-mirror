...
@d zip_writting == 1 {\.{ZIP} compression being used}
...
begin
    ...
    delete_token_ref(def_ref);
    obj_ximage_data(k) := read_image(s, page, named, pdf_option_pdf_minor_version, pdf_option_always_use_pdfpagebox);
