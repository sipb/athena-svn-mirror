...
\entry {\code {--srcdir\r {, for building multiple architectures}}}{9}
\entry {\code {--version}}{40}
\entry {\code {--with \r {options}}}{8}
\entry {\code {--with-mktextex-default}}{12}
\entry {\code {--without-mktexmf-default}}{12}
\entry {\code {--without-mktexpk-default}}{12}
\entry {\code {--without-mktextfm-default}}{12}
\entry {\code {-1 \r {debugging value}}}{22}
\entry {\code {-A \r {option to \code {ls}}}}{36}
\entry {\code {-Bdynamic}}{28}
\entry {\code {-Bstatic}}{28}
\entry {\code {-D \var {num}}}{38}
\entry {\code {-dynamic}}{28}
...
\entry {\code {.pro}}{42}
\entry {\code {.rhosts\r {, writable by \TeX{}}}}{15}
\entry {\code {.tex}}{42}
...
\entry {\code {//}}{34}
\entry {\code {/afs/\dots {} \r {, installing into}}}{11}
...
\initial {{\tt\char 123}}
\entry {\code {{\tt\char 123} \r {expansion}}}{34}
...
\entry {\code {2602gf}}{26}
\initial {8}
\entry {8.3 filenames, using}{13}
\initial {A}
\entry {absolute filenames}{30}
\entry {\code {ac_include\r {, Autoconf extension}}}{7}
\entry {access warnings}{30}
\entry {Acorn \TeX{} implementations}{20}
\entry {\code {AFMFONTS}}{41}
\entry {AFS}{11}
\entry {AIX 4.1 \code {configure} error}{27}
\entry {AIX shells and \code {configure}}{7}
\entry {aliases for fonts}{44}
\entry {aliases, for filenames}{36}
\entry {\code {all}}{46}
\entry {alphabetical order, not}{34}
\entry {Amiga support}{4}
\entry {Amiga \TeX{} implementations}{20}
\entry {Andrew File System, installing with}{11}
\entry {announcement mailing list}{22}
\entry {ANSI C}{27}
\entry {append-only directories and \code {mktexpk}}{15}
\entry {\code {appendonlydir}}{13}
\entry {architecture-(in)dependent files, installing only}{11}
\entry {architectures, compiling multiple}{9}
...
\entry {binary mode, for file transfers}{18}
...
\entry {bug address}{20}
\entry {bug checklist}{21}
\entry {bug mailing list}{22}
\entry {bugs, reporting}{20}
\initial {C}
\entry {\code {c-*.h}}{48}
\entry {\code {c-auto.in}}{7}
\entry {cache of fonts, local}{15}
...
\entry {\code {CFLAGS}}{8}
\entry {\code {ChangeLog \r {entry}}}{21}
...
\entry {common problems}{24}
\entry {\code {comp.sys.sun.admin \r {FAQ}}}{28}
\entry {\code {comp.text.tex}}{22}
\entry {compilation}{3}
\entry {compilation value, source for path}{31}
\entry {compiler bugs}{26}
\entry {compiler bugs, finding}{26}
...
\entry {\code {config.log}}{21}
\entry {\code {config.ps\r {, search path for}}}{41}
\entry {\code {config.status}}{21}
\entry {configuration}{3}
\entry {configuration bugs}{21}
...
\entry {\code {doc files}}{42}
\entry {DOS compatible names}{13}
\entry {DOS support}{4}
\entry {DOS \TeX{} implementations}{20}
\entry {\code {dosnames}}{13}
\entry {dot files}{36}
\entry {doubled colons}{32}
\entry {\code {dpi\var {nnn} directories}}{13}
\entry {DVI drivers}{5}
...
\entry {dynamic creation of files}{12}
\entry {dynamic linking problems with OpenWin libraries}{28}
\initial {E}
\entry {EC fonts, and dynamic source creation}{12}
\entry {\code {elt-dirs.c}}{35}
\entry {email CTAN access}{18}
\entry {enabling \file {mktex} scripts}{12}
...
\entry {epoch, seconds since}{24}
\entry {error message macros}{47}
\entry {excessive startup time}{25}
...
\entry {fallback resolutions, overriding}{10}
\entry {FAQ, \t {comp.sys.sun.admin}}{28}
\entry {FAQ, Kpathsea}{24}
\entry {Farwell, Matthew}{35}
\entry {features, of default paths}{6}
\entry {file formats, supported}{41}
\entry {file lookup}{43}
...
\entry {\code {gdb\r {, recommended}}}{21}
\entry {generation of filename database}{12}
\entry {German \TeX{} CD info}{20}
\entry {\code {get_applicationShellWidgetClass}}{28}
\entry {\code {get_wmShellWidgetClass}}{28}
\entry {\code {gf}}{41}
...
\entry {GNU C compiler bugs}{26}
\entry {GNU General Public License}{1}
\entry {Gopher CTAN access}{18}
...
\entry {help, mailing list for general \TeX{}}{22}
\entry {\code {HIER}}{6}
...
\entry {\code {info-tex@shsu.edu}}{22}
\entry {input lines, reading}{48}
\entry {\code {install-data \r {Make target}}}{11}
\entry {\code {install-exec \r {Make target}}}{11}
\entry {installation}{3}
\entry {installation testing}{15}
\entry {installation, architecture-(in)dependent files only}{11}
...
\entry {Knuth, Donald E., archive of programs by}{20}
...
\entry {\code {kpathsea_debug}}{22}
\entry {\code {KPATHSEA_DEBUG}}{22, 47}
\entry {\code {kpathsea_debug \r {variable}}}{48}
\entry {\code {KPSE_BITMAP_TOLERANCE}}{44}
\entry {\code {kpse_cnf_get}}{49}
\entry {\code {KPSE_DEBUG_EXPAND \r {(16)}}}{23}
\entry {\code {KPSE_DEBUG_FOPEN \r {(4)}}}{23}
\entry {\code {KPSE_DEBUG_HASH \r {(2)}}}{23}
\entry {\code {KPSE_DEBUG_PATHS \r {(8)}}}{23}
\entry {\code {KPSE_DEBUG_SEARCH \r {(32)}}}{23}
\entry {\code {KPSE_DEBUG_STAT \r {(1)}}}{23}
\entry {\code {KPSE_DEBUG_VARS \r {(64)}}}{23}
...
\entry {\code {kpse_format_info_type}}{23}
...
\initial {L}
\entry {\code {labrea.stanford.edu}}{20}
\entry {LaserJet drive}{5}
\entry {last-resort font}{46}
\entry {La\TeX{} help mailing list}{22}
...
\entry {\code {lndir \r {for building symlink trees}}}{9}
\entry {loader options}{9}
\entry {loader options, final}{10}
\entry {loader options, initial}{10}
\entry {local cache of fonts}{15}
\entry {log file}{24}
\entry {logging successful searches}{24}
...
\entry {Macintosh \TeX{} implementations}{20}
...
\entry {Metafont failures}{26}
\entry {Metafont installation}{26}
\entry {Metafont making too-large fonts}{26}
...
\entry {\file {mktex} script configuration}{12}
\entry {\file {mktex} script names}{14}
\entry {\file {mktex} scripts}{12}
\entry {\code {mktex.cnf}}{12}
\entry {\code {mktex.opt}}{12}
\entry {\code {mktexdir}}{13}
\entry {\code {mktexmf}}{14}
\entry {\code {mktexpk}}{14}
\entry {\code {mktexpk \r {, initial runs}}}{4}
\entry {\code {mktextex}}{14}
\entry {\code {mktextfm}}{14}
...
\entry {multiple architectures, compiling on}{9}
\entry {multiple architectures, directories for}{9}
\entry {multiple architectures, installing on}{11}
...
\entry {online Metafont display, spurious}{26}
\entry {OpenWin libraries, dynamic linking problems}{28}
\entry {optimization caveat}{26}
\entry {optimization, enabling}{9}
\entry {options for debugging}{22}
\entry {options to \code {configure}}{8}
\entry {OS/2 support}{4}
\entry {other \TeX{} distributions}{20}
...
\entry {\code {paths.h}}{7}
\entry {\code {paths.h\r {, creating}}}{10}
...
\entry {precompiled Unix binaries}{20}
\entry {preprocessor options}{8}
\entry {preprocessor options, additional}{10}
\entry {printer configuration files}{4}
\entry {privacy, semblance of}{24}
\entry {problems, common}{24}
...
\entry {\code {README.mirrors}}{18}
\entry {recording successful searches}{24}
\entry {relative filenames}{30}
\entry {relative filenames in \file {ls-R}}{11}
\entry {reporting bugs}{20}
...
\entry {stack trace}{21}
\entry {standalone path searching}{37}
\entry {standard error and debugging output}{22}
\entry {standard options}{40}
\entry {startup time, excessive}{25}
\entry {static linking}{28}
...
\entry {te\TeX{}}{20}
\entry {\code {tex-archive@math.utah.edu}}{22}
...
\entry {\code {texmf.cnf\r {, creating}}}{10}
...
\entry {\code {time \r {system call}}}{24}
...
\entry {usage patterns, finding}{24}
\entry {\code {USE_VARTEXFONTS}}{14}
\entry {Usenet \TeX{} newsgroup}{22}
\initial {V}
...
\entry {VMS support}{4}
\entry {VMS \TeX{} implementations}{20}
\entry {Vojta, Paul}{2}
\initial {W}
...
\entry {Windows \TeX{} implementations}{20}
\entry {World Wide Web CTAN access}{18}
\entry {\code {www.tug.org}}{17}
\initial {X}
\entry {X11 previewer}{5}
\entry {X11, lacking on NeXT}{5}
\entry {\code {XCFLAGS}}{10}
\entry {\code {XCPPFLAGS}}{10}
\entry {\code {XDEFS}}{10}
...
\entry {\code {Xmu \r {library problems}}}{28}
\entry {\code {XtStrings}}{27}
\initial {Z}
\entry {zuhn, david}{2}
