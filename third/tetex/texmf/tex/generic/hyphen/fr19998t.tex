% This is a modified version of the file frhyph.tex. Don't ever rename
% it back to frhyph.tex (that breaks the copyright of this file).
%
% I have changes the filename troughout this file and marked all other
% modifications with the marker "te:".
%
% fr19998t.tex % French hyphenation patterns
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This file is available for free and can used and redistributed
% asis for free. Modified versions should have another name.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% te: adjusted the date (99 -> 1999)
\message{fr19998t.tex - french hyphenation patterns (V2.5) <1999/03/08>}
%
% te: due to my modifications, the checksum test will fail, of course...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%          *BEFORE* using this file *PLEASE* run checksum on it:           %
%                       checksum -v fr19998t.tex                           %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% te: adjusted checksum:
%%      checksum        = "06108 1449 3073 34581"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ifx\PFnormaldef\ProvidesFile
  \ProvidesFile{fr19998t.tex}[1999/03/08 % te: corrected the date
                French hyphenation patterns v2.5] % and version number
\fi
\fi
%
...
\endinput
%%
%% End of file `fr19998t.tex'.
% te: removed garbage at the end of this file
