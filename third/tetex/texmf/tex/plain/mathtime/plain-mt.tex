% This is based on the plain TeX format that's described in The TeXbook.

% *********************************************************************
%
% Modified to use MathTime + Times + Courier	Version 1.2	1997/Nov/1
%
% To create a new format using this file, make sure you also have the
% file `hyphen.tex.'  Then run iniTeX on the file `plain-mt.tex'.
% Finally, type \dump when TeX gets through and waits for input.
%
...
% For text, you may need to \input a file like `ansiacce.tex' or `stanacce.tex'
% See notes at end for additional information.
%
% *********************************************************************
...
% We flush this uneccessary way of cluttering up TeX's memory...

\message{fonts,}

% *** *** CHANGES FOR MathTime + Times + Courier COMING UP *** *** *** %
...
\font\tenrm=tir at 10.0pt % roman text
\font\sevenrm=tir at 7.6pt
\font\fiverm=tir at 6.0pt

\font\tenit=tii at 10.0pt % text italic
\font\sevenit=tii at 7.6pt
\font\fiveit=tii at 6.0pt

\font\tenbf=tib at 10.0pt % boldface 
\font\sevenbf=tib at 7.6pt
\font\fivebf=tib at 6.0pt

\font\tentt=com at 10.0pt % typewriter
\font\seventt=com at 7.6pt
\font\fivett=com at 6.0pt

\font\tensl=tio at 10.0pt % slanted roman
\font\sevensl=tio at 7.6pt
\font\fivesl=tio at 6.0pt

% \font\preloaded=hv at 10.0pt % sans serif
% \font\preloaded=hvo at 10.0pt % sans serif italic
% \font\preloaded=hvb at 10.0pt % sans serif bold 

% \font\preloaded=coo at 10.0pt % slanted typewriter
% \font\preloaded=cob at 10.0pt % bold typewriter

% some redundancy in following with fonts introduced by MTMACS.TEX....

\font\teni=mtmi at 10.0pt % math italic
\font\seveni=mtmi at 7.6pt
\font\fivei=mtmi at 6.0pt

\font\tensy=mtsy at 10.0pt % math symbols
\font\sevensy=mtsy at 7.6pt
\font\fivesy=mtsy at 6.0pt

\font\tenex=mtex at 10.0pt % math extension
\font\sevenex=mtex at 7.6pt
\font\fiveex=mtex at 6.0pt

\message{more fonts,}

% MTMACS called at end to set up fonts for math properly
...
% WARNING: the following contain hard-wired numeric character codes.
% Plain TeX sets these up for the encoding used by Computer Modern fonts.
% These may need to be adjusted, depending on the encoding used.
% See `stanacce.tex', `accents.tex',  and so on for examples.
...
% Root defined differently later so one doesn't get a gap 
...
% Need to redefine \matrix later because fonts are used at different size?
% \def\matrix#1{\null\,\vcenter{\normalbaselines\m@th
...
% Ideally, \matrix should be changed because fonts (i.e. MTMI) not at 10pt,
...
\def\fmtname{plain-mt}\def\fmtversion{3.141} % identifies the current format
...
% For examples, see files `ansiacce.tex', `stanacce.tex', `dcaccent.tex' etc
