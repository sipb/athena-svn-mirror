...
%
% Han The Thanh <thanh@fi.muni.cz> 
% Michal Konecny <M.Konecny@cs.bham.ac.uk>
...
\def\selectfontsize#1,{
    ...
    \else
        \dimenA=\@fontsize
        \add \dimenA \dimenA
        \add \dimenA -\cursize\p@
        \add \dimenA -\lastsize\p@
        \relax
        \ifdim\dimenA < \z@
            \edef\selectedsize{\lastsize}
        \else
...
\def\loadfontdecl{
    \excs\ifx\fontdecl\relax
        ...
        \ifisprefix \loadfd{cmr}{pfd}\fi
    \fi
    \excs\ifx\fontdecl\relax
        \testprefix{vcm}{\@fontfamily}
        \ifisprefix \loadfd{vcmr}{pfd}\fi
    \fi
    \excs\ifx\fontdecl\relax
