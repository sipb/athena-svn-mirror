...
There are four options to the \texttt{aeguill} package:

\begin{itemize}
\item `\texttt{pl}' (default): with this, the guillemets
...
The three first solutions have free Type~1 equivalents, the last doesn't.
