@Comment[	$Source: /afs/dev.mit.edu/source/repository/third/krb5/doc/old-V4-docs/installation.mss,v $]
@Comment[	$Author: ghudson $]
@Comment[	$Id: installation.mss,v 1.1.1.1 1996-09-12 04:41:53 ghudson Exp $]
@Comment[]
@device[postscript]
@make[report]
@comment[
