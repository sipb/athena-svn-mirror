 ...
 *
 * $Id: keytab.c,v 1.1.1.5 2001-12-05 20:47:43 rbasch Exp $
...
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/third/krb5/src/kadmin/cli/keytab.c,v 1.1.1.5 2001-12-05 20:47:43 rbasch Exp $";
#endif
