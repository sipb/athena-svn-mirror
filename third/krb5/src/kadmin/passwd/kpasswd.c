 ...
 * 
 * $Header: /afs/dev.mit.edu/source/repository/third/krb5/src/kadmin/passwd/kpasswd.c,v 1.1.1.5 2004-02-27 04:17:08 zacheiss Exp $
 *
 *
 */

static char rcsid[] = "$Id: kpasswd.c,v 1.1.1.5 2004-02-27 04:17:08 zacheiss Exp $";
