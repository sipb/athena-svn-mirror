 ...
 *
 * $Id: kadm_rpc_svc.c,v 1.1.1.5 2001-12-05 20:47:49 rbasch Exp $
 *
 */

#if !defined(lint) && !defined(__CODECENTER__)
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/third/krb5/src/kadmin/server/kadm_rpc_svc.c,v 1.1.1.5 2001-12-05 20:47:49 rbasch Exp $";
#endif
