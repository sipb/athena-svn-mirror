 ...
 *
 * $Header: /afs/dev.mit.edu/source/repository/third/krb5/src/kadmin/server/server_stubs.c,v 1.1.1.2 1997-01-21 09:23:02 ghudson Exp $
 */

#if !defined(lint) && !defined(__CODECENTER__)
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/third/krb5/src/kadmin/server/server_stubs.c,v 1.1.1.2 1997-01-21 09:23:02 ghudson Exp $";
#endif
