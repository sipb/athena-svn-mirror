...
# environment. 
#
# $Id: rpc_test_setup.sh,v 1.1.1.1 1996-09-12 04:44:40 ghudson Exp $
# $Source: /afs/dev.mit.edu/source/repository/third/krb5/src/lib/rpc/unit-test/testsuite/rpc_test_setup.sh,v $
