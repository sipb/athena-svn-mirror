 ...
 *
 * $Id: server.c,v 1.1.1.1 1996-09-12 04:44:39 ghudson Exp $
...
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/third/krb5/src/lib/rpc/unit-test/server.c,v 1.1.1.1 1996-09-12 04:44:39 ghudson Exp $";
#endif
