 ...
 *
 * $Id: server.c,v 1.1.1.2 1997-01-21 09:28:29 ghudson Exp $
 * $Source: /afs/dev.mit.edu/source/repository/third/krb5/src/lib/rpc/unit-test/server.c,v $
 */

#if !defined(lint) && !defined(__CODECENTER__)
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/third/krb5/src/lib/rpc/unit-test/server.c,v 1.1.1.2 1997-01-21 09:28:29 ghudson Exp $";
#endif
