...
# environment. 
#
# $Id: rpc_test_setup.sh,v 1.1.1.3 2004-02-27 04:16:22 zacheiss Exp $
# $Source: /afs/dev.mit.edu/source/repository/third/krb5/src/lib/rpc/unit-test/rpc_test_setup.sh,v $
