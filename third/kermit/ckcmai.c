#define EDITDATE  "17 Mar 2003"		/* Update these with each edit */
#define EDITNDATE "20030317"		/* Keep them in sync */
/* Sun Mar 16 13:52:38 2003 */
...
#ifdef UNIX
static char sccsid[] = "@(#)C-Kermit 8.0.209";
#endif /* UNIX */

char *ck_s_ver = "8.0.209";             /* C-Kermit version string */
long  ck_l_ver =  800209L;              /* C-Kermit version number */

#ifdef OS2
char *ck_s_xver = "2.1.4";		/* Product-specific version string */
long  ck_l_xver = 2104L;                /* Product-specific version number */
#else
#ifdef MAC
...
#ifdef pdp11
"Copyright (C) 1985, 2003, Trustees of Columbia University, NYC.",
"All rights reserved.",
" ",
#else
#ifdef OS2
...
dourl() {
    ...
    if (!ckstrcmp(g_url.svc,"iksd",-1,0) ||
        ...
        if (!g_url.pth) {
		  ...
		  ckmakxmsg(line,10240,   /* Directory name given */
			    "remote login ",
			    g_url.usr,
			    " ",
			    g_url.psw,
