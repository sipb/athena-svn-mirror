...
void
Demo_Echo_echo(Demo_Echo _obj, const CORBA_char * message,
	       CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Demo_Echo__classid) {
      
	 ((POA_Demo_Echo__epv *) _obj->vepv[Demo_Echo__classid])->echo(_obj->
								       servant,
								       message,
								       ev);
      return;
