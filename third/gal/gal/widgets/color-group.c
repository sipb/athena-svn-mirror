...
color_group_class_init (ColorGroupClass *class)
{
	...
	color_group_signals[CUSTOM_COLOR_ADD] =
		gtk_signal_new("custom_color_add",
			       GTK_RUN_LAST,
			       E_OBJECT_CLASS_TYPE (object_class),
			       GTK_SIGNAL_OFFSET (ColorGroupClass, custom_color_add),
			       gtk_marshal_NONE__POINTER,
			       GTK_TYPE_NONE, 1, GTK_TYPE_POINTER);
	E_OBJECT_CLASS_ADD_SIGNALS (object_class, color_group_signals, LAST_SIGNAL);
}
