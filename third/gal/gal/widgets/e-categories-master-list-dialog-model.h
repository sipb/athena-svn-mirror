...
#define E_CATEGORIES_MASTER_LIST_DIALOG_MODEL(o)          (GTK_CHECK_CAST ((o), E_CATEGORIES_MASTER_LIST_DIALOG_MODEL_TYPE, ECategoriesMasterListDialogModel))
#define E_CATEGORIES_MASTER_LIST_DIALOG_MODEL_CLASS(k)    (GTK_CHECK_CLASS_CAST((k), E_CATEGORIES_MASTER_LIST_DIALOG_MODEL_TYPE, ECategoriesMasterListDialogModelClass))
#define E_IS_CATEGORIES_MASTER_LIST_DIALOG_MODEL(o)       (GTK_CHECK_TYPE ((o), E_CATEGORIES_MASTER_LIST_DIALOG_MODEL_TYPE))
#define E_IS_CATEGORIES_MASTER_LIST_DIALOG_MODEL_CLASS(k) (GTK_CHECK_CLASS_TYPE ((k), E_CATEGORIES_MASTER_LIST_DIALOG_MODEL_TYPE))
