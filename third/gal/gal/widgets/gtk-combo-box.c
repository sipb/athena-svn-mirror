...
gtk_combo_box_class_init (GtkObjectClass *object_class)
{
	...
	gtk_combo_box_signals [PRE_POP_DOWN] = gtk_signal_new (
		"pre_pop_down",
		GTK_RUN_LAST,
		E_OBJECT_CLASS_TYPE (object_class),
		GTK_SIGNAL_OFFSET (GtkComboBoxClass, pre_pop_down),
		gtk_marshal_NONE__NONE,
		GTK_TYPE_NONE, 0);

	gtk_combo_box_signals [POST_POP_HIDE] = gtk_signal_new (
		"post_pop_hide",
		GTK_RUN_LAST,
		E_OBJECT_CLASS_TYPE (object_class),
		GTK_SIGNAL_OFFSET (GtkComboBoxClass, post_pop_hide),
		gtk_marshal_NONE__NONE,
		GTK_TYPE_NONE, 0);
	
	E_OBJECT_CLASS_ADD_SIGNALS (object_class, gtk_combo_box_signals, LAST_SIGNAL);
}
...
gtk_combo_box_popup_hide_unconditional (GtkComboBox *combo_box)
{
	...
	gtk_signal_emit (GTK_OBJECT (combo_box), gtk_combo_box_signals [POST_POP_HIDE]);
}
...
gtk_combo_box_popup_display (GtkComboBox *combo_box)
{
	...
	gtk_signal_emit (GTK_OBJECT (combo_box), gtk_combo_box_signals [PRE_POP_DOWN]);
