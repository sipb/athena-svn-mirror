...
#define E_CATEGORIES_MASTER_LIST_DIALOG(o)          (GTK_CHECK_CAST ((o), E_CATEGORIES_MASTER_LIST_DIALOG_TYPE, ECategoriesMasterListDialog))
#define E_CATEGORIES_MASTER_LIST_DIALOG_CLASS(k)    (GTK_CHECK_CLASS_CAST((k), E_CATEGORIES_MASTER_LIST_DIALOG_TYPE, ECategoriesMasterListDialogClass))
#define E_IS_CATEGORIES_MASTER_LIST_DIALOG(o)       (GTK_CHECK_TYPE ((o), E_CATEGORIES_MASTER_LIST_DIALOG_TYPE))
#define E_IS_CATEGORIES_MASTER_LIST_DIALOG_CLASS(k) (GTK_CHECK_CLASS_TYPE ((k), E_CATEGORIES_MASTER_LIST_DIALOG_TYPE))
