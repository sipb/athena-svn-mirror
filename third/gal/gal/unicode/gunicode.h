...
/* UTF-8 versions of convenient glib functions. */

gint   g_utf8_strcasecmp  (const gchar *s1,
			   const gchar *s2);
gint   g_utf8_strncasecmp (const gchar *s1,
			   const gchar *s2,
			   guint n);
gchar *g_utf8_strdown     (gchar *s);
gchar *g_utf8_strup       (gchar *s);
