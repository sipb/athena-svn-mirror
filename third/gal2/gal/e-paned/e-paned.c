...
/* 
 * e-paned.c - A slightly more advanced paned widget.
...
static void    e_paned_set_property (GObject *object,
				     guint prop_id,
				     const GValue *value,
				     GParamSpec *pspec);
static void    e_paned_get_property (GObject *object,
				     guint prop_id,
				     GValue *value,
				     GParamSpec *pspec);
...
static void    e_paned_style_set (GtkWidget *widget,
...
e_paned_class_init (EPanedClass *klass)
{
  ...
  object_class->set_property = e_paned_set_property;
  object_class->get_property = e_paned_get_property;
...
#ifndef NO_WARNINGS
#warning removed expose
#endif
#if 0
  widget_class->expose_event = e_paned_expose;
#endif
  widget_class->style_set = e_paned_style_set;
  ...
  g_object_class_install_property (object_class, PROP_HANDLE_SIZE, 
				   g_param_spec_uint ("handle_size",
						      _("Handle Size"),
						      /*_( */"XXX blurb" /*)*/,
						      0, G_MAXUINT, 0,
						      G_PARAM_READWRITE));

  g_object_class_install_property (object_class, PROP_QUANTUM,
				   g_param_spec_uint ("quantum",
						      _("Quantum"),
						      /*_( */"XXX blurb" /*)*/,
						      0, G_MAXUINT, 0,
						      G_PARAM_READWRITE));
...
static void
e_paned_set_property (GObject *object,
		      guint prop_id,
		      const GValue *value,
		      GParamSpec *pspec)
{
	...
	case PROP_HANDLE_SIZE:
		e_paned_set_handle_size (paned, g_value_get_uint (value));
		break;
	case PROP_QUANTUM:
...
static void
e_paned_get_property (GObject *object,
		      guint prop_id,
		      GValue *value,
		      GParamSpec *pspec)
{
...
static void
e_paned_style_set (GtkWidget *widget, GtkStyle *previous_style)
{
  EPaned *paned;
  g_return_if_fail (widget != NULL);
...
{
  EPanedClass *klass = E_PANED_CLASS(GTK_OBJECT_GET_CLASS(paned));
