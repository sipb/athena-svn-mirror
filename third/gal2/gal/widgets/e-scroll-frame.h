...
#define E_SCROLL_FRAME(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), E_TYPE_SCROLL_FRAME, EScrollFrame))
#define E_SCROLL_FRAME_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), E_TYPE_SCROLL_FRAME,	\
					EScrollFrameClass))
#define E_IS_SCROLL_FRAME(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), E_TYPE_SCROLL_FRAME))
#define E_IS_SCROLL_FRAME_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), E_TYPE_SCROLL_FRAME))
