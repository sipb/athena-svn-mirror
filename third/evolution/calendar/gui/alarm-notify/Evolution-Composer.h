...
#define TC_GNOME_Evolution_Composer_Recipient ((CORBA_TypeCode)&TC_GNOME_Evolution_Composer_Recipient_struct)
   ...
   extern gpointer GNOME_Evolution_Composer_Recipient__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#endif
...
#define TC_CORBA_sequence_GNOME_Evolution_Composer_Recipient ((CORBA_TypeCode)&TC_CORBA_sequence_GNOME_Evolution_Composer_Recipient_struct)
   ...
   extern gpointer CORBA_sequence_GNOME_Evolution_Composer_Recipient__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
...
#define TC_GNOME_Evolution_Composer_RecipientList ((CORBA_TypeCode)&TC_GNOME_Evolution_Composer_RecipientList_struct)
   ...
   extern gpointer GNOME_Evolution_Composer_RecipientList__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#endif
...
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_0 'E'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_1 'v'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_2 'o'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_3 'l'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_4 'u'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_5 't'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_6 'i'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_7 'o'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_8 'n'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_9 '_'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_10 'C'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_11 'o'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_12 'm'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_13 'p'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_14 'o'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_15 's'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_16 'e'
#define ORBIT_IMPL_CORBA_sequence_CORBA_char_17 'r'
   typedef struct
   {
      CORBA_unsigned_long _maximum,
       _length;
...
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_0 'E'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_1 'v'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_2 'o'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_3 'l'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_4 'u'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_5 't'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_6 'i'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_7 'o'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_8 'n'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_9 '_'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_10 'C'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_11 'o'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_12 'm'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_13 'p'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_14 'o'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_15 's'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_16 'e'
#define TC_IMPL_TC_CORBA_sequence_CORBA_char_17 'r'
   extern const struct CORBA_TypeCode_struct
...
#define TC_CORBA_sequence_CORBA_char ((CORBA_TypeCode)&TC_CORBA_sequence_CORBA_char_struct)
   ...
   extern gpointer CORBA_sequence_CORBA_char__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#if !defined(_GNOME_Evolution_Composer_AttachmentData_defined)
#define _GNOME_Evolution_Composer_AttachmentData_defined 1
   typedef CORBA_sequence_CORBA_char GNOME_Evolution_Composer_AttachmentData;
#if !defined(TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_0)
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_0 'E'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_1 'v'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_2 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_3 'l'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_4 'u'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_5 't'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_6 'i'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_7 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_8 'n'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_9 '_'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_10 'C'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_11 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_12 'm'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_13 'p'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_14 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_15 's'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_16 'e'
#define TC_IMPL_TC_GNOME_Evolution_Composer_AttachmentData_17 'r'
   extern const struct CORBA_TypeCode_struct
      TC_GNOME_Evolution_Composer_AttachmentData_struct;
#define TC_GNOME_Evolution_Composer_AttachmentData ((CORBA_TypeCode)&TC_GNOME_Evolution_Composer_AttachmentData_struct)
#endif
   extern GNOME_Evolution_Composer_AttachmentData
      *GNOME_Evolution_Composer_AttachmentData__alloc(void);
   extern gpointer GNOME_Evolution_Composer_AttachmentData__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#endif
#if !defined(_GNOME_Evolution_Composer_MultipartType_defined)
#define _GNOME_Evolution_Composer_MultipartType_defined 1
   typedef enum
   {
      GNOME_Evolution_Composer_MIXED,
      GNOME_Evolution_Composer_ALTERNATIVE
   }
   GNOME_Evolution_Composer_MultipartType;
#if !defined(TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_0)
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_0 'E'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_1 'v'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_2 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_3 'l'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_4 'u'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_5 't'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_6 'i'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_7 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_8 'n'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_9 '_'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_10 'C'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_11 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_12 'm'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_13 'p'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_14 'o'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_15 's'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_16 'e'
#define TC_IMPL_TC_GNOME_Evolution_Composer_MultipartType_17 'r'
   extern const struct CORBA_TypeCode_struct
      TC_GNOME_Evolution_Composer_MultipartType_struct;
#define TC_GNOME_Evolution_Composer_MultipartType ((CORBA_TypeCode)&TC_GNOME_Evolution_Composer_MultipartType_struct)
#endif
#endif
...
#define GNOME_Evolution_Composer_CouldNotParse__alloc() NULL
   extern gpointer GNOME_Evolution_Composer_CouldNotParse__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#endif
...
/** POA structures **/
   typedef struct
   {
      ...
      void (*setMultipartType) (PortableServer_Servant _servant,
				const GNOME_Evolution_Composer_MultipartType
				type, CORBA_Environment * ev);
      void (*setBody) (PortableServer_Servant _servant,
		       const CORBA_char * body, const CORBA_char * mime_type,
      ...
      void (*attachData) (PortableServer_Servant _servant,
			  ...
			  const GNOME_Evolution_Composer_AttachmentData *
			  data, CORBA_Environment * ev);
      void (*show) (PortableServer_Servant _servant, CORBA_Environment * ev);
      void (*send) (PortableServer_Servant _servant, CORBA_Environment * ev);
   }
...
#define GNOME_Evolution_Composer_queryInterface Bonobo_Unknown_queryInterface
   void GNOME_Evolution_Composer_setHeaders(GNOME_Evolution_Composer _obj,
					    ...
					    * bcc, const CORBA_char * subject,
					    CORBA_Environment * ev);
   void GNOME_Evolution_Composer_setMultipartType(GNOME_Evolution_Composer
						  _obj,
						  const
						  GNOME_Evolution_Composer_MultipartType
						  type,
						  CORBA_Environment * ev);
   void GNOME_Evolution_Composer_setBody(GNOME_Evolution_Composer _obj,
   ...
   void GNOME_Evolution_Composer_show(GNOME_Evolution_Composer _obj,
				      CORBA_Environment * ev);
   void GNOME_Evolution_Composer_send(GNOME_Evolution_Composer _obj,
				      CORBA_Environment * ev);
   ...
   void
      ...
      (POA_GNOME_Evolution_Composer * _ORBIT_servant,
       GIOPRecvBuffer * _ORBIT_recv_buffer, CORBA_Environment * ev,
       void (*_impl_setBody) (PortableServer_Servant _servant,
			      const CORBA_char * body,
			      const CORBA_char * mime_type,
			      CORBA_Environment * ev));
   void
   ...
   void _ORBIT_skel_GNOME_Evolution_Composer_show(POA_GNOME_Evolution_Composer
						  * _ORBIT_servant,
						  ...
						  (PortableServer_Servant
						   _servant,
						   CORBA_Environment * ev));
   void _ORBIT_skel_GNOME_Evolution_Composer_send(POA_GNOME_Evolution_Composer
						  * _ORBIT_servant,
						  GIOPRecvBuffer *
						  _ORBIT_recv_buffer,
						  CORBA_Environment * ev,
