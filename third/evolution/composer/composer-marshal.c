...
/* VOID:INT,BOXED (composer-marshal.list:3) */
void
e_msg_composer_marshal_VOID__INT_BOXED (GClosure     *closure,
                                        GValue       *return_value,
...
/* BOOLEAN:INT,POINTER (composer-marshal.list:4) */
void
e_msg_composer_marshal_BOOLEAN__INT_POINTER (GClosure     *closure,
                                             GValue       *return_value,
                                             guint         n_param_values,
                                             const GValue *param_values,
                                             gpointer      invocation_hint,
