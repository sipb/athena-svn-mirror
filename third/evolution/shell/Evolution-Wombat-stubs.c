   ...
   (GNOME_Evolution_WombatInterfaceCheck _obj, CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv
      ...
      _ORBIT_retval =
	 ((POA_GNOME_Evolution_WombatInterfaceCheck__epv *) _obj->
	  vepv[GNOME_Evolution_WombatInterfaceCheck__classid])->
	 _get_interfaceVersion(_obj->servant, ev);
      return _ORBIT_retval;
   }
   if (0)
      return *(&_ORBIT_retval);
