				    ...
				    CORBA_Environment * ev))
{
   ...
   _ORBIT_retval = _impl__get_interfaceVersion(_ORBIT_servant, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
...
static ORBitSkeleton
get_skel_GNOME_Evolution_WombatInterfaceCheck
   (POA_GNOME_Evolution_WombatInterfaceCheck * servant,
...
static void
init_local_objref_GNOME_Evolution_WombatInterfaceCheck(CORBA_Object obj,
						       POA_GNOME_Evolution_WombatInterfaceCheck
						       * servant)
{
   obj->vepv[Bonobo_Unknown__classid] = servant->vepv->Bonobo_Unknown_epv;
   obj->vepv[GNOME_Evolution_WombatInterfaceCheck__classid] =
      servant->vepv->GNOME_Evolution_WombatInterfaceCheck_epv;
}
...
{
   static const PortableServer_ClassInfo class_info =
      { (ORBit_impl_finder) & get_skel_GNOME_Evolution_WombatInterfaceCheck,
"IDL:GNOME/Evolution/WombatInterfaceCheck:1.0",
(ORBit_local_objref_init) & init_local_objref_GNOME_Evolution_WombatInterfaceCheck };
   PortableServer_ServantBase__init(((PortableServer_ServantBase *) servant),
				    env);
   POA_Bonobo_Unknown__init(servant, env);
   ORBIT_OBJECT_KEY(((PortableServer_ServantBase *) servant)->_private)->
      class_info = (PortableServer_ClassInfo *) & class_info;
   if (!GNOME_Evolution_WombatInterfaceCheck__classid)
