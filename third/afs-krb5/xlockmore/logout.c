...
#ifndef lint
static char sccsid[] = "@(#)logout.c	3.11 96/09/20 xlockmore";
...
#if defined( AUTO_LOGOUT ) || defined( LOGOUT_BUTTON ) || defined( USE_BOMB )
...
#if 0
#ifdef VMS
	(void) system("mcr decw$endsession");
#endif
#endif
...
#endif /* AUTO_LOGOUT || LOGOUT_BUTTON */

#endif /* AUTO_LOGOUT || LOGOUT_BUTTON || USE_BOMB */
