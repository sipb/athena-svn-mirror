...
_ORBIT_skel_Trilobite_Eazel_Inventory__get_machine_name
   (POA_Trilobite_Eazel_Inventory * _ORBIT_servant,
    GIOPRecvBuffer * _ORBIT_recv_buffer, CORBA_Environment * ev,
    CORBA_char * (*_impl__get_machine_name) (PortableServer_Servant _servant,
					     CORBA_Environment * ev))
{
   CORBA_char *_ORBIT_retval;

   _ORBIT_retval = _impl__get_machine_name(_ORBIT_servant, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
				     ...
				     CORBA_Environment * ev))
{
   ...
   _impl__set_machine_name(_ORBIT_servant, value, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
						   ...
						   CORBA_Environment * ev))
{
   ...
   _ORBIT_retval = _impl__get_warn_before_upload(_ORBIT_servant, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
					   ...
					   CORBA_Environment * ev))
{
   ...
   _impl__set_warn_before_upload(_ORBIT_servant, value, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
...
_ORBIT_skel_Trilobite_Eazel_Inventory_upload(POA_Trilobite_Eazel_Inventory *
					     ...
					     (PortableServer_Servant _servant,
					      CORBA_Environment * ev))
{
   _impl_upload(_ORBIT_servant, ev);
   {				/* marshalling */
      register GIOPSendBuffer *_ORBIT_send_buffer;
		    ...
		    case 't':
			 ...
			 case '_':
				 ...
				 *impl =
				 ...
				 break;
			      case 'm':
				 if (strcmp((opname + 6), "achine_name"))
				    break;
				 *impl =
				    (gpointer) servant->vepv->
				    Trilobite_Eazel_Inventory_epv->
				 ...
				 if (strcmp
				     ((opname + 6),
				      "arn_before_upload")) break;
				 *impl =
				    (gpointer) servant->vepv->
				    Trilobite_Eazel_Inventory_epv->
				    _get_warn_before_upload;
				 return (ORBitSkeleton)
				    _ORBIT_skel_Trilobite_Eazel_Inventory__get_warn_before_upload;
				 break;
			      default:
