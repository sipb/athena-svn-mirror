...
CORBA_char *
Trilobite_Eazel_Inventory__get_machine_name(Trilobite_Eazel_Inventory _obj,
					    CORBA_Environment * ev)
{
   register GIOP_unsigned_long _ORBIT_request_id,
    _ORBIT_system_exception_minor;
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Inventory__classid) {
      _ORBIT_retval =
	 ((POA_Trilobite_Eazel_Inventory__epv *) _obj->
	  vepv[Trilobite_Eazel_Inventory__classid])->_get_machine_name(_obj->
								       servant,
								       ev);
      return _ORBIT_retval;
   }
...
void
Trilobite_Eazel_Inventory__set_machine_name(Trilobite_Eazel_Inventory _obj,
					    ...
					    CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Inventory__classid) {
	 ...
	 ((POA_Trilobite_Eazel_Inventory__epv *) _obj->
       vepv[Trilobite_Eazel_Inventory__classid])->_set_machine_name(_obj->
								    servant,
								    value,
								    ev);
      return;
...
CORBA_boolean
Trilobite_Eazel_Inventory__get_warn_before_upload(Trilobite_Eazel_Inventory
						  _obj,
						  CORBA_Environment * ev)
{
   register GIOP_unsigned_long _ORBIT_request_id,
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Inventory__classid) {
      _ORBIT_retval =
	 ((POA_Trilobite_Eazel_Inventory__epv *) _obj->
	  vepv[Trilobite_Eazel_Inventory__classid])->
	 _get_warn_before_upload(_obj->servant, ev);
      return _ORBIT_retval;
   }
   if (0)
      return *(&_ORBIT_retval);
...
void
Trilobite_Eazel_Inventory__set_warn_before_upload(Trilobite_Eazel_Inventory
						  _obj,
						  const CORBA_boolean value,
						  CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Inventory__classid) {
	 ...
	 ((POA_Trilobite_Eazel_Inventory__epv *) _obj->
       vepv[Trilobite_Eazel_Inventory__classid])->
_set_warn_before_upload(_obj->servant, value, ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
 _ORBIT_retry_request:
				 ...
				 CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Inventory__classid) {
	 ...
	 ((POA_Trilobite_Eazel_Inventory__epv *) _obj->
       vepv[Trilobite_Eazel_Inventory__classid])->upload(_obj->servant, ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
 _ORBIT_retry_request:
