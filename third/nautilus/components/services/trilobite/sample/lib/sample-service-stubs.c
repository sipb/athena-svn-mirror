...
void
Trilobite_Eazel_Sample_remember(Trilobite_Eazel_Sample _obj,
				...
				CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Sample__classid) {
      
	 ((POA_Trilobite_Eazel_Sample__epv *) _obj->
       vepv[Trilobite_Eazel_Sample__classid])->remember(_obj->servant,
							something, ev);
      return;
   }
 ...
 _ORBIT_retry_request:
   ...
   {				/* marshalling */
	 ...
	 goto _ORBIT_system_exception;
      _ORBIT_tmpvar_1 = strlen(something) + 1;
	 ...
	 giop_message_buffer_append_mem(GIOP_MESSAGE_BUFFER
      ...
      giop_message_buffer_append_mem(GIOP_MESSAGE_BUFFER(_ORBIT_send_buffer),
				     (something),
				     sizeof(something[_ORBIT_tmpvar_0]) *
				     _ORBIT_tmpvar_1);
...
void
Trilobite_Eazel_Sample_say_it(Trilobite_Eazel_Sample _obj,
			      CORBA_Environment * ev)
{
   register GIOP_unsigned_long _ORBIT_request_id,
    _ORBIT_system_exception_minor;
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Sample__classid) {
	 ...
	 ((POA_Trilobite_Eazel_Sample__epv *) _obj->
       vepv[Trilobite_Eazel_Sample__classid])->say_it(_obj->servant, ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
 _ORBIT_retry_request:
...
void
Trilobite_Eazel_Sample_list_it(Trilobite_Eazel_Sample _obj,
			       const CORBA_char * dir, CORBA_Environment * ev)
{
   ...
   if (_obj->servant && _obj->vepv && Trilobite_Eazel_Sample__classid) {
	 ...
	 ((POA_Trilobite_Eazel_Sample__epv *) _obj->
       vepv[Trilobite_Eazel_Sample__classid])->list_it(_obj->servant, dir,
						       ev);
      return;
   }
   _cnx = ORBit_object_get_connection(_obj);
