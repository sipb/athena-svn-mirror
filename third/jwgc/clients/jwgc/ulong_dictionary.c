...
ulong_dictionary 
ulong_dictionary_Create(size)
	int size;
{
	int i;
	ulong_dictionary result;

	result = (ulong_dictionary) malloc(sizeof(struct _ulong_dictionary));
	result->size = size;
	result->slots = (ulong_dictionary_binding **) malloc(
				size * sizeof(ulong_dictionary_binding *));
...
void 
ulong_dictionary_Destroy(d)
	ulong_dictionary d;
{
	int i;
	ulong_dictionary_binding *binding_ptr, *new_binding_ptr;
...
void 
ulong_dictionary_Enumerate(d, proc)
	ulong_dictionary d;
	void (*proc) ( /* ulong_dictionary_binding *b */ );
{
	int i;
	ulong_dictionary_binding *binding_ptr;
...
ulong_dictionary_binding *
ulong_dictionary_Define(d, key, already_existed)
	ulong_dictionary d;
	char *key;
	int *already_existed;
{
	ulong_dictionary_binding **ptr_to_the_slot, *binding_ptr;
	...
	if (already_existed)
		*already_existed = 0;
	binding_ptr = (ulong_dictionary_binding *) malloc(
					 sizeof(ulong_dictionary_binding));
...
void 
ulong_dictionary_Delete(d, b)
	ulong_dictionary d;
	ulong_dictionary_binding *b;
{
	ulong_dictionary_binding **ptr_to_binding_ptr;
