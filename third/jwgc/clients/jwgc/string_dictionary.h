...
#ifndef string_dictionary_TYPE
#define string_dictionary_TYPE
...
typedef struct _string_dictionary_binding {
    struct _string_dictionary_binding *next;       /* PRIVATE */
    char *key;                                     /* READ-ONLY */
    string value;
} string_dictionary_binding;

typedef struct _string_dictionary {                /* PRIVATE */
    int size;
    string_dictionary_binding **slots;
} *string_dictionary;
...
extern string_dictionary string_dictionary_Create(/* int size */);
...
extern void string_dictionary_Destroy(/* string_dictionary d */);
...
extern void string_dictionary_Enumerate(/* string_dictionary d, 
					   void (*proc)() */);
...
extern string_dictionary_binding *string_dictionary_Lookup(/* d, key */);
...
extern string_dictionary_binding *string_dictionary_Define();
...
extern void string_dictionary_Delete();
