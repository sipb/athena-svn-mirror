...
string_dictionary 
string_dictionary_Create(size)
	int size;
{
	int i;
	string_dictionary result;

	result = (string_dictionary) malloc(sizeof(struct _string_dictionary));
	result->size = size;
	result->slots = (string_dictionary_binding **) malloc(
				size * sizeof(string_dictionary_binding *));
...
/*
 *    void string_dictionary_Destroy(string_dictionary d):
 *        Requires: d is a non-destroyed string_dictionary
 *        Modifies: d
...
{
	int i;
	string_dictionary_binding *binding_ptr, *new_binding_ptr;
...
/*
 *    void string_dictionary_Enumerate(string_dictionary d; void (*proc)()):
 *        Requires: proc is a void procedure taking 1 argument, a
 *                  string_dictionary_binding pointer, which does not
...
void 
string_dictionary_Enumerate(d, proc)
	string_dictionary d;
	void (*proc) ( /* string_dictionary_binding *b */ );
{
	int i;
	string_dictionary_binding *binding_ptr;
...
/*
 *    string_dictionary_binding *string_dictionary_Lookup(string_dictionary d,
 *                                                        char *key):
...
string_dictionary_Lookup(d, key)
	string_dictionary d;
	char *key;
{
	string_dictionary_binding *binding_ptr;
...
/*
 *    string_dictionary_binding *string_dictionary_Define(string_dictionary d,
 *                                            char *key,
 *                                            int *already_existed):
 *        Modifies: d
...
string_dictionary_binding *
string_dictionary_Define(d, key, already_existed)
	string_dictionary d;
	char *key;
	int *already_existed;
{
	string_dictionary_binding **ptr_to_the_slot, *binding_ptr;
	...
	if (already_existed)
		*already_existed = 0;
	binding_ptr = (string_dictionary_binding *) malloc(
					 sizeof(string_dictionary_binding));
...
/*
 *    void string_dictionary_Delete(string_dictionary d,
...
void 
string_dictionary_Delete(d, b)
	string_dictionary d;
	string_dictionary_binding *b;
{
	string_dictionary_binding **ptr_to_binding_ptr;
