#ifndef int_dictionary_TYPE
#define int_dictionary_TYPE
...
typedef struct _int_dictionary_binding {
    struct _int_dictionary_binding *next;       /* PRIVATE */
    char *key;                                     /* READ-ONLY */
    int value;
} int_dictionary_binding;

typedef struct _int_dictionary {                /* PRIVATE */
    int size;
    int_dictionary_binding **slots;
} *int_dictionary;
...
extern int_dictionary int_dictionary_Create(/* int size */);
...
extern void int_dictionary_Destroy(/* int_dictionary d */);
...
extern void int_dictionary_Enumerate(/* int_dictionary d, 
					   void (*proc)() */);
...
extern int_dictionary_binding *int_dictionary_Lookup(/* d, key */);
...
extern int_dictionary_binding *int_dictionary_Define();
...
extern void int_dictionary_Delete();
