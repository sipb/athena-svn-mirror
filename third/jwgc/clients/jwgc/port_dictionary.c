...
port_dictionary 
port_dictionary_Create(size)
	int size;
{
	int i;
	port_dictionary result;

	result = (port_dictionary) malloc(sizeof(struct _port_dictionary));
	result->size = size;
	result->slots = (port_dictionary_binding **) malloc(
				size * sizeof(port_dictionary_binding *));
...
void 
port_dictionary_Destroy(d)
	port_dictionary d;
{
	int i;
	port_dictionary_binding *binding_ptr, *new_binding_ptr;
...
void 
port_dictionary_Enumerate(d, proc)
	port_dictionary d;
	void (*proc) ( /* port_dictionary_binding *b */ );
{
	int i;
	port_dictionary_binding *binding_ptr;
...
port_dictionary_binding *
port_dictionary_Define(d, key, already_existed)
	port_dictionary d;
	char *key;
	int *already_existed;
{
	port_dictionary_binding **ptr_to_the_slot, *binding_ptr;
	...
	if (already_existed)
		*already_existed = 0;
	binding_ptr = (port_dictionary_binding *) malloc(
					 sizeof(port_dictionary_binding));
...
void 
port_dictionary_Delete(d, b)
	port_dictionary d;
	port_dictionary_binding *b;
{
	port_dictionary_binding **ptr_to_binding_ptr;
