#include "pointer.h"
#ifndef pointer_dictionary_TYPE
#define pointer_dictionary_TYPE
...
typedef struct _pointer_dictionary_binding {
    struct _pointer_dictionary_binding *next;       /* PRIVATE */
    char *key;                                     /* READ-ONLY */
    pointer value;
} pointer_dictionary_binding;

typedef struct _pointer_dictionary {                /* PRIVATE */
    int size;
    pointer_dictionary_binding **slots;
} *pointer_dictionary;
...
extern pointer_dictionary pointer_dictionary_Create(/* int size */);
...
extern void pointer_dictionary_Destroy(/* pointer_dictionary d */);
...
extern void pointer_dictionary_Enumerate(/* pointer_dictionary d, 
					   void (*proc)() */);
...
extern pointer_dictionary_binding *pointer_dictionary_Lookup(/* d, key */);
...
extern pointer_dictionary_binding *pointer_dictionary_Define();
...
extern void pointer_dictionary_Delete();
