...
void 
TYPE_T_dictionary_Enumerate(d, proc)
	TYPE_T_dictionary d;
...
TYPE_T_dictionary_Lookup(d, key)
	TYPE_T_dictionary d;
	char *key;
{
	TYPE_T_dictionary_binding *binding_ptr;
...
TYPE_T_dictionary_binding *
TYPE_T_dictionary_Define(d, key, already_existed)
	TYPE_T_dictionary d;
	char *key;
	int *already_existed;
{
