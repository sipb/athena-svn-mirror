...
/*  $Header: /afs/dev.mit.edu/source/repository/third/gcalctool/gcalctool/gtk.c,v 1.1.1.2 2005-03-10 19:15:31 ghudson Exp $
 *
...
static void gcalc_window_have_icons_notify(GConfClient *client, guint cnxn_id,
 ...
 * We need to set/unset the icons if 
 * /desktop/gnome/interface/menus_have_icons toggles.
 */

    static gchar *action_image[] = {
        "Quit", 
        "Copy", 
        "Paste", 
        "Contents", 
