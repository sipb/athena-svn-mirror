...
ClassInfo_t ClassInfo[] = {
    ...
    { CN_SOFTINFO,	ShowSoftInfo,	ListSoftInfo,
      "Software Information", "S O F T W A R E   I N F O R M A T I O N" },
    { CN_PARTITION,	ShowPartition,	ListPartition,
      "Partition Information", "P A R T I T I O N   I N F O R M A T I O N" },
    ...
    char		       *Names;
{
	 ...
	 * of class names.
	 */
	String = (char *) strdup(Names);
	for (cp = (char *) strtok(String, ","); 
	     cp; cp = (char *) strtok((char *)NULL, ",")) {
