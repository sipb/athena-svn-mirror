...
#define MCL_UPGRADE		0x04		/* Upgrade license */
#define MCLN_UPGRADE		"upgrade"

/*
 * Values for mcl_t.Flags
 */
#define MCLF_DEBUG		0x01		/* Enable debug info */
...
struct _mcl {
    ...
    time_t			DaysLeft;	/* #Days before expires */
    ...
    char		       *TimeStampFile;	/* File for time stamp check */
    time_t			DemoPeriod;	/* Time allowed for demo */
    /* Internal usage */
    struct _mcl		       *Next;
};
