...
struct htab
{
  ...
  Word_t         logsize; /* log of size of table */
  ...
  struct bjreroot *space;   /* space for the hitems */
...
/* hcreate - create a hash table
   ...
   RETURNS:
     the new table
 */
htab_t *hcreate(/*_ Word_t logsize _*/);
 ...
 */
Word_t  hfind(/*_ htab *t, ub1 *key, ub4 keyl _*/);
 ...
 */
Word_t  hadd(/*_ htab *t, ub1 *key, ub4 keyl, void *stuff _*/);
