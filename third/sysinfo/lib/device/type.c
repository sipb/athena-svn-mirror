 ...
 */
DevType_t DevTypes[] = {
    /* Allow "none" for entries which should be ignored */
    { DT_NONE,		DTN_NONE,	NULL,			NULL },
    ...
    { DT_CONTROLLER,	DTN_ADAPTER,	"controller",		PrintGeneric },
    ...
    { DT_DVD,		DTN_DVD,	"DVD drive",		PrintGeneric },
    { DT_CD,		DTN_CD,		"CD drive",		PrintGeneric },
