...
PyObject *
libxml_htmlDefaultSAXHandlerInit(PyObject *self, PyObject *args) {
...
libxml_xmlNewNode(PyObject *self, PyObject *args) {
    ...
    if (!PyArg_ParseTuple(args, "Oz:xmlNewNode", &pyobj_ns, &name))
        return(NULL);
    ns = (xmlNsPtr) PyxmlNode_Get(pyobj_ns);

    c_retval = xmlNewNode(ns, name);
    py_retval = libxml_xmlNodePtrWrap((xmlNodePtr) c_retval);
    return(py_retval);
}
...
PyObject *
libxml_xmlDefaultSAXHandlerInit(PyObject *self, PyObject *args) {
