...
#define GNOME_GtkHTML_Editor_Listener__free CORBA_Object__free
...
#define TC_IMPL_TC_GNOME_GtkHTML_Editor_Listener_5 'r'
   extern const struct CORBA_TypeCode_struct
      TC_GNOME_GtkHTML_Editor_Listener_struct;
...
#define GNOME_GtkHTML_Editor_Engine__free CORBA_Object__free
...
#define TC_IMPL_TC_GNOME_GtkHTML_Editor_Engine_5 'r'
   extern const struct CORBA_TypeCode_struct
      TC_GNOME_GtkHTML_Editor_Engine_struct;
...
#endif
   extern GNOME_GtkHTML_Editor_URLRequestEvent
      *GNOME_GtkHTML_Editor_URLRequestEvent__alloc(void);
   extern gpointer GNOME_GtkHTML_Editor_URLRequestEvent__free(gpointer mem, gpointer dat, CORBA_boolean free_strings);	/* ORBit internal use */
#endif
   ...
   typedef struct
   {
      ...
      void (*_set_listener) (PortableServer_Servant _servant,
       ...
       CORBA_boolean(*runCommand) (PortableServer_Servant _servant,
				   ...
				   CORBA_Environment * ev);
      CORBA_char *(*getParagraphData) (PortableServer_Servant _servant,
...
#define GNOME_GtkHTML_Editor_Engine_queryInterface Bonobo_Unknown_queryInterface
   ...
   CORBA_boolean
      GNOME_GtkHTML_Editor_Engine_runCommand(GNOME_GtkHTML_Editor_Engine _obj,
					     ...
					     CORBA_Environment * ev);
   CORBA_char
      *GNOME_GtkHTML_Editor_Engine_getParagraphData
      (GNOME_GtkHTML_Editor_Engine _obj, const CORBA_char * key,
       CORBA_Environment * ev);
   void
   ...
   void
      ...
      (POA_GNOME_GtkHTML_Editor_Engine * _ORBIT_servant,
       GIOPRecvBuffer * _ORBIT_recv_buffer, CORBA_Environment * ev,
       CORBA_char *
       (*_impl_getParagraphData) (PortableServer_Servant _servant,
				  const CORBA_char * key,
				  CORBA_Environment * ev));
   void
   ...
   void
      ...
      (POA_GNOME_GtkHTML_Editor_Engine * _ORBIT_servant,
       ...
       void (*_impl_insertHTML) (PortableServer_Servant _servant,
				 ...
				 CORBA_Environment * ev));
   void
      _ORBIT_skel_GNOME_GtkHTML_Editor_Engine_freeze
      (POA_GNOME_GtkHTML_Editor_Engine * _ORBIT_servant,
       GIOPRecvBuffer * _ORBIT_recv_buffer, CORBA_Environment * ev,
       void (*_impl_freeze) (PortableServer_Servant _servant,
			     CORBA_Environment * ev));
   void
      _ORBIT_skel_GNOME_GtkHTML_Editor_Engine_thaw
      (POA_GNOME_GtkHTML_Editor_Engine * _ORBIT_servant,
       GIOPRecvBuffer * _ORBIT_recv_buffer, CORBA_Environment * ev,
