...
GType
gail_canvas_widget_get_type (void)
{
  static GType type = 0;
  ...
  if (!type)
    {
      ...
      {
        sizeof (GailCanvasWidgetClass),
        (GBaseInitFunc) NULL, /* base init */
        (GBaseFinalizeFunc) NULL, /* base finalize */
        (GClassInitFunc) gail_canvas_widget_class_init, /* class init */
        (GClassFinalizeFunc) NULL, /* class finalize */
        NULL, /* class data */
        sizeof (GailCanvasWidget), /* instance size */
        0, /* nb preallocs */
