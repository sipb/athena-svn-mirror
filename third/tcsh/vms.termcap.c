/* $Header: /afs/dev.mit.edu/source/repository/third/tcsh/vms.termcap.c,v 1.1.1.3 2005-06-03 14:35:32 ghudson Exp $ */
/*
 ...
 */
#include "sh.h"
RCSID("$Id: vms.termcap.c,v 1.1.1.3 2005-06-03 14:35:32 ghudson Exp $")
