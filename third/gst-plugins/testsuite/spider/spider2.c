 ...
 * and a stereo volume ! fakesink, where the spider ! volume connection
 * is done through a _filtered connection
 * the difference is thus that the _filtered is done directly on spider
 * and not on the element after it
 */
