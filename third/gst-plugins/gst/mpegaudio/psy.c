...
void mpegaudio_psycho_anal(buffer,savebuf,chn,lay,snr32,sfreq)
short int *buffer;
...
/* variables placed on the stack.                                        */
 ...
 mpegaudio_mem_free((void **) &grouped_c);
 mpegaudio_mem_free((void **) &grouped_e);
 mpegaudio_mem_free((void **) &nb);
 mpegaudio_mem_free((void **) &cb);
 mpegaudio_mem_free((void **) &ecb);
 mpegaudio_mem_free((void **) &bc);
 mpegaudio_mem_free((void **) &wsamp_r);
 mpegaudio_mem_free((void **) &wsamp_i);
 mpegaudio_mem_free((void **) &phi);
 mpegaudio_mem_free((void **) &energy);
 mpegaudio_mem_free((void **) &c);
 mpegaudio_mem_free((void **) &fthr);
 mpegaudio_mem_free((void **) &snrtmp);
}
