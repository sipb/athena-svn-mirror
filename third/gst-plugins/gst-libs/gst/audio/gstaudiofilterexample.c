 ...
 * gstaudiofiltertemplate.c,v 1.4 2004/05/21 23:38:49 leroutier Exp 
 * and
 * $Id: gstaudiofilterexample.c,v 1.1.1.1 2004-10-06 18:29:39 ghudson Exp $
 */
...
#define GST_AUDIOFILTER_TEMPLATE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_AUDIOFILTER_TEMPLATE,GstAudiofilterExample))
#define GST_AUDIOFILTER_TEMPLATE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_AUDIOFILTER_TEMPLATE,GstAudiofilterExampleClass))
...
gst_audiofilter_template_get_type (void)
{
  ...
  if (!audiofilter_template_type) {
    ...
    audiofilter_template_type = g_type_register_static (GST_TYPE_AUDIOFILTER,
        "GstAudiofilterExample", &audiofilter_template_info, 0);
  }
...
{
  //GstAudiofilterExample *audiofilter_template = GST_AUDIOFILTER_TEMPLATE (instance);
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,
    ...
    plugin_init, VERSION, "LGPL", GST_PACKAGE, GST_ORIGIN)
     ...
     static void gst_audiofilter_template_setup (GstAudiofilter * audiofilter)
{
  GstAudiofilterExample *audiofilter_template;
