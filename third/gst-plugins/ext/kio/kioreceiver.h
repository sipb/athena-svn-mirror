...
class KioReceiver : public QObject
{
    ...
    protected:
        ...
        int m_jobNum;
        bool m_progressInfo;
        signed int m_maxPreread;
        signed int m_minRead, m_maxRead;
        ...
        signed int m_bufferOffset;         // unused bytes at the beginning of the buffer list
        signed int m_bufferLen;            // buffer len in bytes
        QByteArray *m_extraBuffer;  // extra buffer to merge buffers

        signed int m_curPosition;          // position in the file
        signed int m_fileSize;             // file size or -1
