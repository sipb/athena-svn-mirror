...
#ifndef __GST_XMMS_EFFECT_H__
#define __GST_XMMS_EFFECT_H__
...
typedef struct _GstXmmsEffect GstXmmsEffect;
 ...
 * structure. */
typedef struct _GstXmmsEffectClass GstXmmsEffectClass;

struct _GstXmmsEffectClass {
  GstElementClass parent_class;

  EffectPlugin *in_plugin;

  /* signals */
  void (*asdf) (GstElement *element, GstXmmsEffect *xmms_effect);
};
 ...
 * of the object.
 */
#define GST_TYPE_XMMS_EFFECT \
  (gst_xmms_effect_get_type())
 ...
 */
#define GST_XMMS_EFFECT(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_XMMS_EFFECT,GstXmmsEffect))
/* The third is a checking cast of the class instead of the object. */
#define GST_XMMS_EFFECT_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_XMMS_EFFECT,GstXmmsEffect))
/* The last two simply check to see if the passed pointer is an object or
 * class of the correct type. */
#define GST_IS_XMMS_EFFECT(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_XMMS_EFFECT))
#define GST_IS_XMMS_EFFECT_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_XMMS_EFFECT))

void gst_xmms_effect_register (GstPlugin *plugin, GList *plugin_list);
