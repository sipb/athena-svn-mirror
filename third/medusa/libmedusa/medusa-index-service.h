...
typedef enum {
  MEDUSA_INDEXER_REQUEST_OK,
  MEDUSA_INDEXER_ERROR_BUSY,
  MEDUSA_INDEXER_ERROR_NO_RESPONSE,
  MEDUSA_INDEXER_ERROR_NO_INDEXER_PRESENT
} MedusaIndexingRequestResult;

/* Returns TRUE if index request was accepted */
MedusaIndexingRequestResult medusa_index_service_request_reindex                (void);
