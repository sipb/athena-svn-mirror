...
# RCSID: $Header: /afs/dev.mit.edu/source/repository/third/transcript/src/mkprinter.sh,v 1.1.1.1 1996-10-07 20:25:49 ghudson Exp $
#
...
#	(one of pscomm, qmscomm, lpcomm, or milancomm)
