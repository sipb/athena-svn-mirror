...
_NOTICE N1[] = "Copyright (c) 1985,1987,1990,1992 Adobe Systems Incorporated";
_NOTICE N2[] = "GOVERNMENT END USERS: See Notice file in TranScript library directory";
_NOTICE N3[] = "-- probably /usr/lib/ps/Notice";
_NOTICE RCSID[]="$Header: /afs/dev.mit.edu/source/repository/third/transcript/src/psplot.c,v 1.1.1.1 1996-10-07 20:25:52 ghudson Exp $";
#endif
/* psplot.c
 *
 ...
 * Release 4.0
 *
 * Revision 3.2  1992/07/14  22:13:32  snichols
 * Updated copyright.
 *
 ...
 * Release 3.0
 *
 * Revision 2.3  1990/12/12  10:39:01  snichols
