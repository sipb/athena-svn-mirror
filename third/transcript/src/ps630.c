...
_NOTICE RCSID[]="$Header: /afs/dev.mit.edu/source/repository/third/transcript/src/ps630.c,v 1.1.1.1 1996-10-07 20:25:49 ghudson Exp $";
#endif
/* ps630.c
 *
 ...
 * Revision 3.3  1993/05/25  21:14:37  snichols
 * *** empty log message ***
 *
 * Revision 3.2  1993/04/28  17:34:19  snichols
 * make compiler happy.
 *
 ...
 * Release 3.0
 *
 * Revision 2.5  1991/03/26  01:01:03  snichols
 * added forward declarations to make gcc happy.
 *
 * Revision 2.4  1991/01/07  09:22:39  snichols
 * got rid of types.h, which was difficult to compile with some compilers.  Put
 * the necessary typedefs directly into this file.
 *
 * Revision 2.3  90/12/12  10:03:30  snichols
...
private long margintop, marginbot,	/* top and bottom margins (points) */
...
private long strstackcount;        /* Number of strings on justify/center
					 stack */

private cardinal nspaces;

#define mkHU(n) ((float) ((n)*0.6))
#define mkVU(n) ((float) ((n)*1.5))
