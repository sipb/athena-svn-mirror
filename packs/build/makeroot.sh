#!/bin/sh
# $Id: makeroot.sh,v 1.14 2003-03-19 15:22:35 ghudson Exp $
...
linux)
  ...
  rpms=`awk '
    ...
    /\/(iptables|pciutils|redhat-config-xfree86|shapecfg|sndconfig)-/ { next; }
    /\/(gnome-pilot|tcpdump|pygtk|nfs-utils|kudzu-devel|xsri)-/ { next; }
    { print $1; }' $list`
