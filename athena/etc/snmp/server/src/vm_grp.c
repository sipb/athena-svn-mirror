 ...
 *    Revision 2.1  1993/06/18 14:36:00  root
...
#ifndef lint
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/athena/etc/snmp/server/src/vm_grp.c,v 2.2 1997-02-27 06:48:02 ghudson Exp $";
#endif
