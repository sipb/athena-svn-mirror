 ...
 *    Revision 2.0  1992/04/22 01:57:23  tom
 *    release 7.4
 *    	no changes
 *
...
#ifndef lint
static char *rcsid = "$Header: /afs/dev.mit.edu/source/repository/athena/etc/snmp/server/src/nfs_grp.c,v 2.1 1997-02-27 06:47:39 ghudson Exp $";
#endif
