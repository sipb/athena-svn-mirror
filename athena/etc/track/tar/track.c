/*
 *	$Source: /afs/dev.mit.edu/source/repository/athena/etc/track/tar/track.c,v $
 *	$Header: /afs/dev.mit.edu/source/repository/athena/etc/track/tar/track.c,v 1.1 1993-10-12 04:48:54 probe Exp $
 *
...
#ifndef lint
static char *rcsid_header_h = "$Header: /afs/dev.mit.edu/source/repository/athena/etc/track/tar/track.c,v 1.1 1993-10-12 04:48:54 probe Exp $";
#endif lint
