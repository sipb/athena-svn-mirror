 ...
 *	$Id: status.c,v 1.11 1990-07-16 08:17:16 lwvanels Exp $
 *	$Author: lwvanels $
 */

#ifndef lint
static char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/lib/status.c,v 1.11 1990-07-16 08:17:16 lwvanels Exp $";
#endif
