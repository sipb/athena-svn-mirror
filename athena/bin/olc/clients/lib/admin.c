 ...
 *
 *	$Source: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/lib/admin.c,v $
 *	$Id: admin.c,v 1.1 1991-11-05 14:06:09 lwvanels Exp $
 *	$Author: lwvanels $
 */

#ifndef lint
#ifndef SABER
static char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/lib/admin.c,v 1.1 1991-11-05 14:06:09 lwvanels Exp $";
#endif
#endif
