 ...
 *	$Id: p_list.c,v 1.5 1990-05-26 12:11:11 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/parser/p_list.c,v 1.5 1990-05-26 12:11:11 vanharen Exp $";
#endif
