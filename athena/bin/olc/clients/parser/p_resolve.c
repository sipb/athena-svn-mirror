 ...
 *	$Id: p_resolve.c,v 1.8 1990-05-26 12:11:51 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/parser/p_resolve.c,v 1.8 1990-05-26 12:11:51 vanharen Exp $";
#endif
