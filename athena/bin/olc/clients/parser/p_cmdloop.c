 ...
 *	$Id: p_cmdloop.c,v 1.9 1990-05-26 12:10:55 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/parser/p_cmdloop.c,v 1.9 1990-05-26 12:10:55 vanharen Exp $";
#endif
