 ...
 *	$Id: t_topic.c,v 1.7 1990-05-26 12:00:38 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/tty/t_topic.c,v 1.7 1990-05-26 12:00:38 vanharen Exp $";
#endif
     ...
     int display;
{
  ...
  switch(status)
    ...
    case ERROR:
      fprintf(stderr,"Cannot list OLC topics\n");
      status = ERROR;
      break;
