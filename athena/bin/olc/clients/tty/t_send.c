 ...
 *	$Id: t_send.c,v 1.9 1990-05-26 12:00:19 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/tty/t_send.c,v 1.9 1990-05-26 12:00:19 vanharen Exp $";
#endif
