 ...
 *	$Id: t_utils.c,v 1.15 1990-05-26 12:00:42 vanharen Exp $
 *	$Author: vanharen $
 */

#ifndef lint
static const char rcsid[] ="$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/clients/tty/t_utils.c,v 1.15 1990-05-26 12:00:42 vanharen Exp $";
#endif
