 ...
 *	$Author: treese $
 *	$Locker:  $
 *	$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/browser/curses/cref.c,v 1.1 1986-01-18 18:08:59 treese Exp $
 */

#ifndef lint
static char *rcsid_cref_c = "$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/browser/curses/cref.c,v 1.1 1986-01-18 18:08:59 treese Exp $";
#endif	lint
...
#ifndef lint
static char rcsid[] = "$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/browser/curses/cref.c,v 1.1 1986-01-18 18:08:59 treese Exp $";
#endif
...
/* Function:	get_comm_count() returns the number of CREF commands.
 * Arguments:	None.
 * Returns:	Number of CREF commands.
 * Notes:
 */
...
get_comm_count()
{
	return(sizeof(Command_Table)/sizeof(COMMAND));
}
