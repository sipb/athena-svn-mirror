...
#ifndef lint
#ifndef SABER
static char *RCSid = "$Header: /afs/dev.mit.edu/source/repository/athena/bin/olc/server/rpd/rpd.c,v 1.4 1990-11-27 14:09:44 lwvanels Exp $";
#endif
#endif
     ...
     int signal;
{
  ...
  shutdown(sock,2);
  close(sock);
  psignal(signal,"rpd shutting down: ");
  exit(0);
}
