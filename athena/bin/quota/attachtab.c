/*
 * $Id: attachtab.c,v 1.10.2.1 1998-10-30 19:43:05 ghudson Exp $
 *
...
#ifndef lint
static char rcsid_attachtab_c[] = "$Id: attachtab.c,v 1.10.2.1 1998-10-30 19:43:05 ghudson Exp $";
#endif lint
...
void lock_attachtab()
{
	...
	if (fp = fopen("/etc/athena/attach.conf","r")) {
		...
		if (sscanf(buf, "attachtab %s", attachtab_fn) == 1) {
		    initd = 1;
		    break;
		}
	    }
