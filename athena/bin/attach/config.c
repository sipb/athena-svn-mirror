 ...
 *	$Author: ghudson $
 *	$Header: /afs/dev.mit.edu/source/repository/athena/bin/attach/config.c,v 1.9.2.1 1999-01-05 19:05:21 ghudson Exp $
 */

#ifndef lint
static char *rcsid_config_c = "$Header: /afs/dev.mit.edu/source/repository/athena/bin/attach/config.c,v 1.9.2.1 1999-01-05 19:05:21 ghudson Exp $";
#endif
