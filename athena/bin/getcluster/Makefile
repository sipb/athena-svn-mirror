...
#	$Header: /afs/dev.mit.edu/source/repository/athena/bin/getcluster/Makefile,v 1.5 1990-02-09 09:35:42 epeisach Exp $
...
depend:
	touch Make.depend; /usr/athena/makedepend -fMake.depend ${CFLAGS} getcluster.c
