 ...
 *	$Author: ghudson $
 *	$Locker:  $
 *	$Header: /afs/dev.mit.edu/source/repository/athena/bin/lpr/printjob.c,v 1.27.2.2 1997-10-17 07:04:43 ghudson Exp $
 */
...
static char *rcsid_printjob_c = "$Id: printjob.c,v 1.27.2.2 1997-10-17 07:04:43 ghudson Exp $";
#endif
