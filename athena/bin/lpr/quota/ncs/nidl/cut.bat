...
:: ========================================================================== 
::
::   Make floppies for NIDL from staging area (MS/DOS)
::     Usage: cut [-high_density] [-test target_dir] [-no_verify]
...
xcopy bin\nidl.exe            %DEST%\bin\ %VERIFY%
xcopy examples\bank           %DEST%\examples\bank\ %VERIFY%
xcopy examples\binop          %DEST%\examples\binop\ /s %VERIFY%
...
type  nul                     >%DEST%\disk%DISK_NUM%.id
copy  cpyright                %DEST% %VERIFY%
xcopy examples\perf           %DEST%\examples\perf\ %VERIFY%
xcopy idl\c\*.*               %DEST%\idl\c\ %VERIFY%
...
type  nul                     >%DEST%\disk%DISK_NUM%.id
copy  cpyright                %DEST% %VERIFY%
xcopy examples\lb_test        %DEST%\examples\lb_test\ %VERIFY%
xcopy examples\mandel         %DEST%\examples\mandel\ %VERIFY%
xcopy examples\rrpc           %DEST%\examples\rrpc\ %VERIFY%
xcopy examples\splash         %DEST%\examples\splash\ %VERIFY%
...
:usage
echo Usage: cut [-high_density] [-test target_dir] [-no_verify]
