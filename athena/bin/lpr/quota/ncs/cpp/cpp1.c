...
#if HOST == SYS_MSDOS
int	ninc = 0;			/* number of system include files */
#endif
...
#ifdef cray
	/*
	 * Explicitly put out some valid piece of C stuff so the Cray
	 * C compiler will get the module name from the main file, not
	 * the first include file.
	 */
	printf("static char ___CPP_DUMMY___;\n");
#endif
	/*
