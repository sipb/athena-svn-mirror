 ...
 *
 * Edit History
 * 12-Sep-87 KA		Don't complain about nested comments
 * 02-Sep-87 NWM	Make "elide $" mean "change $ to _"
 * 02-Jun-87 GLW	Added support to elide '$' in input tokens
