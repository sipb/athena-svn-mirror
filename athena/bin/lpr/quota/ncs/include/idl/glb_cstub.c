...
static void glb_$lookup_csr
 ...
 (
  ...
  /* [out] */lb_$entry_t result_entries_[1],
  /* [out] */status_$t *status_)
#else
...
static void glb_$find_server_csr
#ifdef __STDC__
 (
  /* [in] */handle_t h_)
#else
...
globaldef glb_$epv_t glb_$client_epv = {
glb_$insert_csr,
glb_$delete_csr,
glb_$lookup_csr,
glb_$find_server_csr
};
