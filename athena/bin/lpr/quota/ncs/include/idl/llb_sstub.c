...
/* server call */
llb_$lookup(h, &object_, &obj_type_, &obj_interface_, &entry_handle_, max_num_results_, &num_results_, result_entries_, &status_);
bound=0;
...
globaldef llb_$epv_t llb_$manager_epv = {
llb_$insert,
llb_$delete,
llb_$lookup
};

static rpc_$server_stub_t llb_$server_epva[]={
(rpc_$server_stub_t)llb_$insert_ssr,
(rpc_$server_stub_t)llb_$delete_ssr,
(rpc_$server_stub_t)llb_$lookup_ssr
};
globaldef rpc_$epv_t llb_$server_epv=(rpc_$epv_t)llb_$server_epva;
