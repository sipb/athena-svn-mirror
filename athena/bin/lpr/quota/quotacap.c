...
#ifdef QUOTACAP
#define tgetent	qgetent
#define tskip	qskip
#define tgetstr	qgetstr
#define tdecode qdecode
#define tgetnum	qgetnum
#define	tgetflag qgetflag
#define tdecode qdecode
#define tnchktc	qnchktc
#define	tnamatch qnamatch
#define V6
#endif
	...
	register char *bp;
{
	...
	if (pfp == NULL && (pfp = fopen(qcapfilename, "r")) == NULL)
		return(-1);
	tbuf = bp;
	for (;;) {
		switch (c = getc(pfp)) {
