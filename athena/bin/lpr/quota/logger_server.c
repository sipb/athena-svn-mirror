 ...
 *	$Author: epeisach $
 *	$Header: /afs/dev.mit.edu/source/repository/athena/bin/lpr/quota/logger_server.c,v 1.1 1990-04-16 16:27:22 epeisach Exp $
 */

#if (!defined(lint) && !defined(SABER))
static char logger_server_rcsid[] = "$Header: /afs/dev.mit.edu/source/repository/athena/bin/lpr/quota/logger_server.c,v 1.1 1990-04-16 16:27:22 epeisach Exp $";
