/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/bin/dash/dash.c,v $
 * $Author: ghudson $ 
 *
...
static char *rcsid =
"$Header: /afs/dev.mit.edu/source/repository/athena/bin/dash/dash.c,v 1.1 1998-12-27 15:45:27 ghudson Exp $";
#endif
...
#include <Jets/Menu.h>
#include <Jets/DClock.h>
#include <Jets/AClock.h>
#include <Jets/Form.h>
#include <Jets/Tree.h>
 ...
 *
 */
static int psetenv(name, value, overwrite)
     char *name, *value;
     int overwrite;
{
  char *string;
...
void setupEnvironment()
{
  ...
  if (displayName != NULL)
    psetenv("DISPLAY", displayName, True);
