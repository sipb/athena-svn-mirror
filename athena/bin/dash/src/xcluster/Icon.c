/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/bin/dash/src/xcluster/Icon.c,v $
 * $Author: cfields $ 
 *
...
#ifndef	lint
static char rcsid[] =
"$Header: /afs/dev.mit.edu/source/repository/athena/bin/dash/src/xcluster/Icon.c,v 1.1 1992-04-29 14:12:22 cfields Exp $";
#endif	lint
