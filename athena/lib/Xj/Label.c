/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Label.c,v $
 * $Author: ghudson $ 
 *
...
static char *rcsid =
"$Header: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Label.c,v 1.1 1998-12-17 16:23:05 ghudson Exp $";
#endif
