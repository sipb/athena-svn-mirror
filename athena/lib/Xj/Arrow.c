/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Arrow.c,v $
 * $Author: ghudson $ 
 *
...
static char rcsid[] =
"$Header: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Arrow.c,v 1.1 1998-12-17 16:23:02 ghudson Exp $";
#endif
