/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Window.c,v $
 * $Author: ghudson $ 
 *
...
static char *rcsid =
"$Header: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Window.c,v 1.1 1998-12-17 16:23:10 ghudson Exp $";
#endif
...
#ifdef notdef
  if (me->window.geometry != NULL  ||  me->window.defGeometry )
    {
#endif
...
/*      if (ret_height != 1) *//* figure the right way from the docs */
  ...
  me->window.sizeHints.win_gravity = (me->window.forceNWGravity
				      ? NorthWestGravity
				      : ret_gravity);
  me->window.sizeHints.flags |= PWinGravity | PMinSize;
}
