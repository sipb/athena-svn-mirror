/*
 * $Source: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Form.c,v $
 * $Author: ghudson $ 
 *
...
static char *rcsid =
"$Header: /afs/dev.mit.edu/source/repository/athena/lib/Xj/Form.c,v 1.1 1998-12-17 16:23:04 ghudson Exp $";
#endif
