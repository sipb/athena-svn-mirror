...
/*	$Author: vrt $
/*	$Header: /afs/dev.mit.edu/source/repository/athena/lib/gdb/lib/gdb_serv.c,v 1.1 1993-04-28 09:43:06 vrt Exp $
/*
...
#ifndef lint
static char rcsid_gdb_serv_c[] = "$Header: /afs/dev.mit.edu/source/repository/athena/lib/gdb/lib/gdb_serv.c,v 1.1 1993-04-28 09:43:06 vrt Exp $";
#endif
...
#include <sys/ioctl.h>
	...
	/*----------------------------------------------------------*/
	/*	
	/*	The following field names and types describe the tuple
	/*	sent from clients to servers during connection setup
	/*	negotiation.
	/*	
	/*----------------------------------------------------------*/
...
char *g_fsv_field_names[] = {"disposition",
			     "server_id",	/* suggested new server */
						/* and parms if connection */
						/* is being forwarded */
			     "parms"};
...
TUPLE *responsep;
{
	...
	/*----------------------------------------------------------*/
	/*	
	/*	OK, we sent it out, now let's read back the response.
	/*	
	/*----------------------------------------------------------*/
...
/*	client.  Reply is sent as a tuple.
/*	
/************************************************************************/
...
char *parms;					/*   "     "       */
{
	...
	register TUPLE t;
       ...
       /*
        * Make sure the supplied connection is a legal one, allocate
        * space for our state
        */
