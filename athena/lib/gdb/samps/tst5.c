...
/*	Revised:	8/21/87
/*
/*	$Source: /afs/dev.mit.edu/source/repository/athena/lib/gdb/samps/tst5.c,v $
/*	$Author: probe $
/*	$Header: /afs/dev.mit.edu/source/repository/athena/lib/gdb/samps/tst5.c,v 1.1 1993-10-12 03:24:58 probe Exp $
/*
...
/*	is the client in a server/client pair.  It does a start server
/*	connection and then acts like tst2, sending a bunch of structured
/*	data to its server.
/*	
...
#ifndef lint
static char rcsid_tst5_c[] = "$Header: /afs/dev.mit.edu/source/repository/athena/lib/gdb/samps/tst5.c,v 1.1 1993-10-12 03:24:58 probe Exp $";
#endif
...
/************************************************************************/
	...
	peer = start_server_connection(argv[1], "Dummy parms");
	...
	printf("start_server_connection returned 0x%x\n", peer);
