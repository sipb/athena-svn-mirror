...
#include <netdb.h>
#ifndef lint
static const char *rcsid_zctl_c = "$Id: zctl.c,v 1.24.2.2 1998-08-14 19:43:20 ghudson Exp $";
#endif
	...
	char *argv[];
{
	...
	printf("ZCTL $Revision: 1.24.2.2 $ (Protocol %s%d.%d) - Type '?' for a list of commands.\n\n",
	       ZVERSIONHDR,
