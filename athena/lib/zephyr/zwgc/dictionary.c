 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/dictionary.c,v $
 *      $Author: ghudson $
 *
...
static const char rcsid_dictionary_c[] = "$Id: dictionary.c,v 1.1 1997-09-14 22:13:54 ghudson Exp $";
#endif
