 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/new_memory.c,v $
 *      $Author: ghudson $
 *
...
static const char rcsid_new_memory_c[] = "$Id: new_memory.c,v 1.1 1997-09-14 22:14:18 ghudson Exp $";
#endif
