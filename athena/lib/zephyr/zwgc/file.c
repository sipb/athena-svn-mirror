 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/file.c,v $
 *      $Author: marc $
 *
...
static char rcsid_file_c[] = "$Header: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/file.c,v 1.2 1989-11-02 01:56:02 marc Exp $";
#endif
