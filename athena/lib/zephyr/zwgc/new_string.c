 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/new_string.c,v $
 *      $Author: ghudson $
 *
...
static const char rcsid_new_string_c[] = "$Id: new_string.c,v 1.1 1997-09-14 22:14:21 ghudson Exp $";
#endif
