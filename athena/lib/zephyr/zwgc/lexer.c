 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/lexer.c,v $
 *      $Author: marc $
 *
...
static char rcsid_lexer_c[] = "$Header: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/lexer.c,v 1.2 1989-11-02 01:56:16 marc Exp $";
#endif
