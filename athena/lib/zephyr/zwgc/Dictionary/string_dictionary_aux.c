 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/Dictionary/string_dictionary_aux.c,v $
 *      $Author: jtkohl $
 *
...
static char rcsid_string_dictionary_aux_c[] = "$Id: string_dictionary_aux.c,v 1.1 1989-11-08 14:26:43 jtkohl Exp $";
#endif
