 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/Dictionary/dictionary.c,v $
 *      $Author: jtkohl $
 *
...
static char rcsid_dictionary_c[] = "$Id: dictionary.c,v 1.1 1989-11-08 14:26:34 jtkohl Exp $";
#endif
