 ...
 *
 *      $Source: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/variables.c,v $
 *      $Author: marc $
 *
...
static char rcsid_variables_c[] = "$Header: /afs/dev.mit.edu/source/repository/athena/lib/zephyr/zwgc/variables.c,v 1.2 1989-11-02 01:57:52 marc Exp $";
#endif
