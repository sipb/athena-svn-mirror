 ...
 *------------------------------------------------------------------
 *
 * $Source: /afs/dev.mit.edu/source/repository/athena/lib/ss/test.c,v $
 * $Revision: 1.1 $
...
static char const rcsid_test_c[] =
    "$Header: /afs/dev.mit.edu/source/repository/athena/lib/ss/test.c,v 1.1 1993-10-12 02:50:52 probe Exp $";
#endif /* lint */
