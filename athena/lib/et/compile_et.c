...
static const char rcsid_compile_et_c[] =
    "$Header: /afs/dev.mit.edu/source/repository/athena/lib/et/compile_et.c,v 1.1 1989-02-27 19:01:48 shanzer Exp $";
#endif
...
#undef check_lang
    ...
    *p = 'h';
    ...
    fputs("static struct et_list link = { (struct et_list *) 0, &et };\n\n",
	  cfile);
